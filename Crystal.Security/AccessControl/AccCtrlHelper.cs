...
namespace Crystal.Security.AccessControl
{
	...
	public static class AccessControlHelper
	{
		...
		[Obsolete("This function will be retired in a future release. Use the AceCount extension method from Crystal.PInvoke.WinNTExtensions in the Crystal.PInvoke.Security package.")]
		...
		[Obsolete("This function will be retired in a future release. Use the Length extension method from Crystal.PInvoke.WinNTExtensions in the Crystal.PInvoke.Security package.")]
	...
	/// <seealso cref="Crystal.InteropServices.PinnedObject"/>
