...
namespace System.Runtime.InteropServices
{
	...
	{
		public static string GetString(string value, params object[] vars) => string.Format(Crystal.Properties.Resources.ResourceManager.GetString(value) ?? throw new InvalidOperationException(), vars);
	}
}
