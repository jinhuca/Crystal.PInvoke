...
namespace Crystal.IO
{
	...
	public static class PathEx
	{
		...
		/// </returns>
		public static string HasSuffix(string path, string[] suffixes) => Crystal.Extensions.StringHelper.GetString(PathFindSuffixArray(path, suffixes, suffixes.Length));
