...
using static Crystal.PInvoke.WinINet;
using FILETIME = System.Runtime.InteropServices.ComTypes.FILETIME;

namespace Crystal.Network
{
	...
	public class InternetProxyOptions : IDisposable
	{
		...
		private T GetOption<T>(INTERNET_PER_CONN_OPTION_ID pco)
		{
			...
			using var pIco = new SafeCoTaskMemStruct<INTERNET_PER_CONN_OPTION>(ico, Marshal.SizeOf(typeof(INTERNET_PER_CONN_OPTION)) + (Kernel32.MAX_PATH * Crystal.Extensions.StringHelper.GetCharSize()));
