...
namespace Crystal.PInvoke
{
	public static partial class Gdi32
	{
		...
		public struct FIXED
		{
			...
			/// <summary>Performs an implicit conversion from <see cref="Crystal.PInvoke.Gdi32.FIXED"/> to <see cref="System.Decimal"/>.</summary>
			...
			/// <summary>Performs an implicit conversion from <see cref="System.Decimal"/> to <see cref="Crystal.PInvoke.Gdi32.FIXED"/>.</summary>
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<GLYPHSET>), nameof(cRanges))]
		[StructLayout(LayoutKind.Sequential)]
