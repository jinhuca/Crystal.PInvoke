...
using static Crystal.PInvoke.FunctionHelper;
...
namespace Crystal.PInvoke
{
	public static partial class Kernel32
	{
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<GROUP_RELATIONSHIP>), nameof(ActiveGroupCount))]
		[StructLayout(LayoutKind.Sequential, Pack = 4)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<PROCESSOR_RELATIONSHIP>), nameof(GroupCount))]
		[StructLayout(LayoutKind.Sequential, Pack = 4)]
