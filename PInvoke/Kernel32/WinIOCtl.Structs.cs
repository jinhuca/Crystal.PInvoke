...
namespace Crystal.PInvoke
{
	public static partial class Kernel32
	{
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DRIVE_LAYOUT_INFORMATION>), nameof(PartitionCount))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DRIVE_LAYOUT_INFORMATION_EX>), nameof(PartitionCount))]
		[StructLayout(LayoutKind.Explicit)]
			...
			public string Name
			{
				get
				{
					unsafe
					{
						fixed (ulong* p = &ul1)
						{
							return Crystal.Extensions.StringHelper.GetString((IntPtr)p, CharSet.Unicode, nameBytes);
						}
					}
				}
				set
				{
					unsafe
					{
						fixed (ulong* p = &ul1)
						{
							Crystal.Extensions.StringHelper.Write(value, (IntPtr)p, out _, true, CharSet.Unicode, nameBytes);
						}
					}
				}
			}
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<USN_RECORD_V4>), nameof(NumberOfExtents))]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<VOLUME_DISK_EXTENTS>), nameof(NumberOfDiskExtents))]
		[StructLayout(LayoutKind.Sequential)]
