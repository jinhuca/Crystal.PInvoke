...
{
	/// <summary>Items from the Crystal.dll</summary>
	public static partial class Crystal
	{
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-penumsourcefiletokenscallback PENUMSOURCEFILETOKENSCALLBACK
		// Penumsourcefiletokenscallback; BOOL Penumsourcefiletokenscallback( PVOID token, size_t size ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PENUMSOURCEFILETOKENSCALLBACK")]
		...
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-pfindfileinpathcallback PFINDFILEINPATHCALLBACK
		// Pfindfileinpathcallback; BOOL Pfindfileinpathcallback( PCSTR filename, PVOID context ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PFINDFILEINPATHCALLBACK")]
		...
		/// <para>If the function returns <c>FALSE</c>, the enumeration will stop.</para>
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-psym_enumeratesymbols_callback
		...
		[UnmanagedFunctionPointer(CallingConvention.Winapi, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PSYM_ENUMERATESYMBOLS_CALLBACK")]
		...
		/// <para>If the function returns <c>FALSE</c>, the enumeration will stop.</para>
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-psym_enumlines_callback PSYM_ENUMLINES_CALLBACK
		// PsymEnumlinesCallback; BOOL PsymEnumlinesCallback( PSRCCODEINFO LineInfo, PVOID UserContext ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PSYM_ENUMLINES_CALLBACK")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>If the function returns <c>FALSE</c>, the enumeration will stop.</para>
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-psym_enumprocesses_callback PSYM_ENUMPROCESSES_CALLBACK
		// PsymEnumprocessesCallback; BOOL PsymEnumprocessesCallback( HANDLE hProcess, PVOID UserContext ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PSYM_ENUMPROCESSES_CALLBACK")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>If the function returns <c>FALSE</c>, the enumeration will stop.</para>
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-psym_enumsourcefiles_callback PSYM_ENUMSOURCEFILES_CALLBACK
		// PsymEnumsourcefilesCallback; BOOL PsymEnumsourcefilesCallback( PSOURCEFILE pSourceFile, PVOID UserContext ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PSYM_ENUMSOURCEFILES_CALLBACK")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-psymbol_funcentry_callback PSYMBOL_FUNCENTRY_CALLBACK
		// PsymbolFuncentryCallback; PVOID PsymbolFuncentryCallback( HANDLE hProcess, DWORD AddrBase, PVOID UserContext ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PSYMBOL_FUNCENTRY_CALLBACK")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-psymbol_funcentry_callback64 PSYMBOL_FUNCENTRY_CALLBACK64
		// PsymbolFuncentryCallback64; PVOID PsymbolFuncentryCallback64( HANDLE hProcess, ULONG64 AddrBase, ULONG64 UserContext ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PSYMBOL_FUNCENTRY_CALLBACK64")]
		...
		/// will attempt to load the symbols again if the callback function sets the FileName member of this structure. Crystal 5.1: This
		...
		/// CBA_DEBUG_INFO event. The CallbackData parameter is a pointer to a IMAGEHLP_CBA_EVENT structure. Crystal 6.6 and earlier: This
		/// value is not supported.
		/// </term>
		/// </item>
		/// <item>
		...
		/// <term>
		/// Display verbose information for source server. The CallbackData parameter is a pointer to a string. Crystal 6.6 and earlier:
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-psymbol_registered_callback PSYMBOL_REGISTERED_CALLBACK
		// PsymbolRegisteredCallback; BOOL PsymbolRegisteredCallback( HANDLE hProcess, ULONG ActionCode, PVOID CallbackData, PVOID
		// UserContext ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PSYMBOL_REGISTERED_CALLBACK")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>For a more extensive example, read Getting Notifications.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-psymbol_registered_callback64 PSYMBOL_REGISTERED_CALLBACK64
		...
		// UserContext ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PSYMBOL_REGISTERED_CALLBACK64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		public enum CBA : uint
		{
			...
			/// load the symbols again if the callback function sets the FileName member of this structure.
			/// </para>
			/// <para>Crystal 5.1: This value is not supported.</para>
			/// </summary>
			...
			/// <para>The CallbackData parameter is a pointer to a IMAGEHLP_CBA_EVENT structure.</para>
			/// <para>Crystal 6.6 and earlier: This value is not supported.</para>
			/// </summary>
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumSourceLines")]
		[Flags]
		public enum ESLFLAG
		{
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetHomeDirectory")]
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSymbolFile")]
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymFindFileInPath")]
		[Flags]
		public enum SSRVOPT
		{
			/// <summary>
			...
			/// <summary>
			/// If data is TRUE, SymSrv will not use the downstream store specified in _NT_SYMBOL_PATH. Crystal 6.0 and earlier: This value
			/// is not supported.
			/// </summary>
			SSRVOPT_SECURE = 0x00000200,

			/// <summary>SymSrv will provide debug trace information. Crystal 5.1: This value is not supported.</summary>
			SSRVOPT_TRACE = 0x00000400,

			/// <summary>
			/// The data parameter specifies the value passed to the SymbolServerCallback function in the context parameter. Crystal 6.0 and
			...
			/// Servers and Internet Firewalls. Crystal 6.0 and earlier: This value is not supported.
			/// </summary>
			...
			/// Crystal 6.0 and earlier: This value is not supported.
			/// </summary>
			SSRVOPT_DOWNSTREAM_STORE = 0x00002000,

			/// <summary>
			/// If data is TRUE, SymSrv will overwrite the downlevel store from the symbol store. Crystal 6.1 and earlier: This value is not supported.
			/// </summary>
			...
			/// <summary>
			/// If data is TRUE, SymSrv uses the default downstream store as a flat directory. Crystal 6.1 and earlier: This value is not supported.
			/// </summary>
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumSymbolsEx")]
		[Flags]
		public enum SYMENUM
		{
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSetOptions")]
		[Flags]
		public enum SYMOPT : uint
		{
			...
			/// module. Crystal translates them to absolute addresses. There are symbols that are stored as an absolute address. These have
			/// very specialized purposes and are typically not used.
			/// <para>Crystal 5.1 and earlier: This value is not supported.</para>
			/// </summary>
			SYMOPT_ALLOW_ABSOLUTE_SYMBOLS = 0x00000800,

			/// <summary>
			/// Enables the use of symbols that do not have an address. By default, Crystal filters out symbols that do not have an address.
			/// </summary>
			...
			/// <para>Crystal 6.1 and earlier: This value is not supported.</para>
			/// </summary>
			...
			/// <summary>
			/// Do not use private symbols. The version of Crystal that shipped with earlier Windows release supported only public symbols;
			...
			/// <summary>
			/// Crystal will not load any symbol server other than SymSrv. SymSrv will not use the downstream store specified in
			/// _NT_SYMBOL_PATH. After this flag has been set, it cannot be cleared.
			/// <para>Crystal 6.0 and 6.1: This flag can be cleared.</para>
			/// <para>Crystal 5.1: This value is not supported.</para>
			/// </summary>
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSearch")]
		[Flags]
		public enum SYMSEARCH
		{
			/// <summary>Include all symbols and other data in the .pdb files. Crystal 6.6 and earlier: This value is not supported.</summary>
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSrvStoreFile")]
		[Flags]
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symaddrincludeinlinetrace DWORD IMAGEAPI
		// SymAddrIncludeInlineTrace( HANDLE hProcess, DWORD64 Address );
		[DllImport(Lib_Crystal, SetLastError = false, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymAddrIncludeInlineTrace")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symaddsourcestream BOOL IMAGEAPI SymAddSourceStream( HANDLE
		// hProcess, ULONG64 Base, PCSTR StreamFile, PBYTE Buffer, size_t Size );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymAddSourceStream")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <remarks>
		/// <para>
		/// All Crystal functions, such as this one, are single threaded. Therefore, calls from more than one thread to this function will
		...
		/// </para>
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symaddsymbol BOOL IMAGEAPI SymAddSymbol( HANDLE hProcess,
		// ULONG64 BaseOfDll, PCSTR Name, DWORD64 Address, DWORD Size, DWORD Flags );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymAddSymbol")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <term>
		/// The data parameter contains a string that specifies the downstream store path. For more information, see Using SymSrv. Crystal
		...
		/// Internet Firewalls. Crystal 6.0 and earlier: This value is not supported.
		/// </term>
		/// </item>
		/// <item>
		...
		/// <term>
		/// If data is TRUE, SymSrv will not use the downstream store specified in _NT_SYMBOL_PATH. Crystal 6.0 and earlier: This value is
		/// not supported.
		/// </term>
		/// </item>
		/// <item>
		...
		/// <term>SymSrv will provide debug trace information. Crystal 5.1: This value is not supported.</term>
		/// </item>
		/// <item>
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symcleanup BOOL IMAGEAPI SymCleanup( HANDLE hProcess );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymCleanup")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </list>
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symcompareinlinetrace DWORD IMAGEAPI SymCompareInlineTrace(
		// HANDLE hProcess, DWORD64 Address1, DWORD InlineContext1, DWORD64 RetAddress1, DWORD64 Address2, DWORD64 RetAddress2 );
		[DllImport(Lib_Crystal, SetLastError = false, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymCompareInlineTrace")]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symdeletesymbol BOOL IMAGEAPI SymDeleteSymbol( HANDLE
		// hProcess, ULONG64 BaseOfDll, PCSTR Name, DWORD64 Address, DWORD Flags );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymDeleteSymbol")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// <para>
		/// To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR. <c>SymEnumerateModulesW64</c> is defined as
		/// follows in Crystal.h.
		/// </para>
		/// <para>
		/// <code> BOOL IMAGEAPI SymEnumerateModulesW64( __in HANDLE hProcess, __in PSYM_ENUMMODULES_CALLBACKW64 EnumModulesCallback, __in_opt PVOID UserContext ); #ifdef Crystal_TRANSLATE_TCHAR #define SymEnumerateModules64 SymEnumerateModulesW64 #endif</code>
		/// </para>
		/// <para>
		/// This function supersedes the <c>SymEnumerateModules</c> function. For more information, see Updated Platform Support.
		/// <c>SymEnumerateModules</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumeratemodules BOOL IMAGEAPI SymEnumerateModules(
		// HANDLE hProcess, PSYM_ENUMMODULES_CALLBACK EnumModulesCallback, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true, CharSet = CharSet.Ansi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumerateModules")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>For an example, see Enumerating Symbol Modules.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumeratemodules64 BOOL IMAGEAPI SymEnumerateModules64(
		// HANDLE hProcess, PSYM_ENUMMODULES_CALLBACK64 EnumModulesCallback, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Ansi, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumerateModules64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>For an example, see Enumerating Symbol Modules.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumeratemodulesw64 BOOL IMAGEAPI
		// SymEnumerateModulesW64( HANDLE hProcess, PSYM_ENUMMODULES_CALLBACKW64 EnumModulesCallback, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Unicode, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumerateModulesW64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumlines BOOL IMAGEAPI SymEnumLines( HANDLE hProcess,
		// ULONG64 Base, PCSTR Obj, PCSTR File, PSYM_ENUMLINES_CALLBACK EnumLinesCallback, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumLines")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumprocesses BOOL IMAGEAPI SymEnumProcesses(
		// PSYM_ENUMPROCESSES_CALLBACK EnumProcessesCallback, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumProcesses")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumsourcefiles BOOL IMAGEAPI SymEnumSourceFiles( HANDLE
		// hProcess, ULONG64 ModBase, PCSTR Mask, PSYM_ENUMSOURCEFILES_CALLBACK cbSrcFiles, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumSourceFiles")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumsourcefiletokens BOOL IMAGEAPI
		// SymEnumSourceFileTokens( HANDLE hProcess, ULONG64 Base, PENUMSOURCEFILETOKENSCALLBACK Callback );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumSourceFileTokens")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumsourcelines BOOL IMAGEAPI SymEnumSourceLines( HANDLE
		...
		/// than one thread to this function.
		/// </para>
		/// <para>To call the Unicode version of this function, define <c>Crystal_TRANSLATE_TCHAR</c>.</para>
		/// <para>Examples</para>
		/// <para>For an example, see Enumerating Symbols.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumsymbols BOOL IMAGEAPI SymEnumSymbols( HANDLE
		// hProcess, ULONG64 BaseOfDll, PCSTR Mask, PSYM_ENUMERATESYMBOLS_CALLBACK EnumSymbolsCallback, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumSymbols")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>If the function fails, the return value is <c>FALSE</c>. To retrieve extended error information, call GetLastError.</para>
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumsymbolsex BOOL IMAGEAPI SymEnumSymbolsEx( HANDLE
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumsymbolsforaddr BOOL IMAGEAPI SymEnumSymbolsForAddr(
		// HANDLE hProcess, DWORD64 Address, PSYM_ENUMERATESYMBOLS_CALLBACK EnumSymbolsCallback, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumSymbolsForAddr")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumtypes BOOL IMAGEAPI SymEnumTypes( HANDLE hProcess,
		// ULONG64 BaseOfDll, PSYM_ENUMERATESYMBOLS_CALLBACK EnumSymbolsCallback, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumTypes")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symenumtypesbyname BOOL IMAGEAPI SymEnumTypesByName( HANDLE
		// hProcess, ULONG64 BaseOfDll, PCSTR mask, PSYM_ENUMERATESYMBOLS_CALLBACK EnumSymbolsCallback, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymEnumTypesByName")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symfinddebuginfofile HANDLE IMAGEAPI SymFindDebugInfoFile(
		// HANDLE hProcess, PCSTR FileName, PSTR DebugFilePath, PFIND_DEBUG_FILE_CALLBACK Callback, PVOID CallerData );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymFindDebugInfoFile")]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symfindexecutableimage HANDLE IMAGEAPI
		...
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymFindExecutableImage")]
		...
		/// <item>
		/// <term>
		/// If Crystal is looking for a .pdb file, the id parameter specifies the PDB signature as found in the codeview debug directory of
		/// the original image. Parameter two specifies the PDB age. Parameter three is unused and set to zero.
		/// </term>
		/// </item>
		/// <item>
		/// <term>
		/// If Crystal is looking for any other type of image, such as an executable file or .dbg file, the id parameter specifies the
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symfindfileinpath BOOL IMAGEAPI SymFindFileInPath( HANDLE
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symfromaddr BOOL IMAGEAPI SymFromAddr( HANDLE hProcess,
		// DWORD64 Address, PDWORD64 Displacement, PSYMBOL_INFO Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymFromAddr")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symfromindex BOOL IMAGEAPI SymFromIndex( HANDLE hProcess,
		// ULONG64 BaseOfDll, DWORD Index, PSYMBOL_INFO Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymFromIndex")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </returns>
		/// <remarks/>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symfrominlinecontextw BOOL IMAGEAPI SymFromInlineContextW(
		// HANDLE hProcess, DWORD64 Address, ULONG InlineContext, PDWORD64 Displacement, PSYMBOL_INFOW Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymFromInlineContextW")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symfromname BOOL IMAGEAPI SymFromName( HANDLE hProcess,
		// PCSTR Name, PSYMBOL_INFO Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymFromName")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symfromtokenw BOOL IMAGEAPI SymFromTokenW( HANDLE hProcess,
		// DWORD64 Base, DWORD Token, PSYMBOL_INFOW Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymFromTokenW")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <c>SymFunctionTableAccess</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symfunctiontableaccess PVOID IMAGEAPI
		// SymFunctionTableAccess( HANDLE hProcess, DWORD AddrBase );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymFunctionTableAccess")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symfunctiontableaccess64 PVOID IMAGEAPI
		// SymFunctionTableAccess64( HANDLE hProcess, DWORD64 AddrBase );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymFunctionTableAccess64")]
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symfunctiontableaccess64accessroutines PVOID IMAGEAPI
		...
		[DllImport(Lib_Crystal, SetLastError = false, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymFunctionTableAccess64AccessRoutines")]
		...
		/// <term>
		/// Turns off explicit updates to the last access time of a symbol that is loaded. By default, Crystal updates the last access time
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetextendedoption BOOL IMAGEAPI SymGetExtendedOption(
		// IMAGEHLP_EXTENDED_OPTIONS option );
		[DllImport(Lib_Crystal, SetLastError = false, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetExtendedOption")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetfilelineoffsets64 ULONG IMAGEAPI
		// SymGetFileLineOffsets64( HANDLE hProcess, PCSTR ModuleName, PCSTR FileName, PDWORD64 Buffer, ULONG BufferLines );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetFileLineOffsets64")]
		...
		/// <summary>Retrieves the home directory used by Crystal.</summary>
		/// <param name="type">
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgethomedirectory PCHAR IMAGEAPI SymGetHomeDirectory(
		...
		/// </para>
		/// <para>
		/// To call the Unicode version of this function, define <c>Crystal_TRANSLATE_TCHAR</c>. <c>SymGetLineFromAddrW64</c> is defined as
		/// follows in Crystal.h.
		/// </para>
		/// <para>
		/// <code>BOOL IMAGEAPI SymGetLineFromAddrW64( _In_ HANDLE hProcess, _In_ DWORD64 dwAddr, _Out_ PDWORD pdwDisplacement, _Out_ PIMAGEHLP_LINEW64 Line ); #ifdef Crystal_TRANSLATE_TCHAR #define SymGetLineFromAddr64 SymGetLineFromAddrW64 #endif</code>
		/// </para>
		/// <para>
		/// This function supersedes the <c>SymGetLineFromAddr</c> function. For more information, see Updated Platform Support.
		/// <c>SymGetLineFromAddr</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// <para>For an example, see Retrieving Symbol Information by Address.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetlinefromaddr
		// BOOL IMAGEAPI SymGetLineFromAddr( HANDLE hProcess, DWORD dwAddr, PDWORD pdwDisplacement, PIMAGEHLP_LINE Line );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetLineFromAddr")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>For an example, see Retrieving Symbol Information by Address.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetlinefromaddr64 BOOL IMAGEAPI SymGetLineFromAddr64(
		// HANDLE hProcess, DWORD64 qwAddr, PDWORD pdwDisplacement, PIMAGEHLP_LINE64 Line64 );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Ansi, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetLineFromAddr64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// <para>
		/// To call the Unicode version of this function, define <c>Crystal_TRANSLATE_TCHAR</c>. <c>SymGetLineFromInlineContext</c> is
		/// defined as follows in Crystal.h.
		/// </para>
		/// <para>
		/// <code>BOOL IMAGEAPI SymGetLineFromInlineContextW( _In_ HANDLE hProcess, _In_ DWORD64 dwAddr, _In_ ULONG InlineContext, _In_opt_ DWORD64 qwModuleBaseAddress, _Out_ PDWORD pdwDisplacement, _Out_ PIMAGEHLP_LINEW64 Line ); #ifdef Crystal_TRANSLATE_TCHAR #define SymGetLineFromInlineContext SymGetLineFromInlineContextW #endif</code>
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetlinefrominlinecontext BOOL IMAGEAPI
		...
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetLineFromInlineContext")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// <para>
		/// To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR. <c>SymGetLineFromNameW64</c> is defined as follows
		/// in Crystal.h.
		/// </para>
		/// <para>
		/// <code> BOOL IMAGEAPI SymGetLineFromNameW64( __in HANDLE hProcess, __in_opt PCWSTR ModuleName, __in_opt PCWSTR FileName, __in DWORD dwLineNumber, __out PLONG plDisplacement, __inout PIMAGEHLP_LINEW64 Line ); #ifdef Crystal_TRANSLATE_TCHAR #define SymGetLineFromName64 SymGetLineFromNameW64 #endif</code>
		/// </para>
		/// <para>
		/// This function supersedes the <c>SymGetLineFromName</c> function. For more information, see Updated Platform Support.
		/// <c>SymGetLineFromName</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// <para>For an example, see Retrieving Symbol Information by Name.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetlinefromname BOOL IMAGEAPI SymGetLineFromName( HANDLE
		// hProcess, PCSTR ModuleName, PCSTR FileName, DWORD dwLineNumber, PLONG plDisplacement, PIMAGEHLP_LINE Line );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Ansi, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetLineFromName")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>For an example, see Retrieving Symbol Information by Name.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetlinefromname64 BOOL IMAGEAPI SymGetLineFromName64(
		// HANDLE hProcess, PCSTR ModuleName, PCSTR FileName, DWORD dwLineNumber, PLONG plDisplacement, PIMAGEHLP_LINE64 Line );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Ansi, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetLineFromName64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>For an example, see Retrieving Symbol Information by Name.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetlinefromnamew64 BOOL IMAGEAPI SymGetLineFromNameW64(
		// HANDLE hProcess, PCWSTR ModuleName, PCWSTR FileName, DWORD dwLineNumber, PLONG plDisplacement, PIMAGEHLP_LINEW64 Line );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Unicode, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetLineFromNameW64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// <para>
		/// To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR. <c>SymGetLineNextW64</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		/// <code> BOOL IMAGEAPI SymGetLineNextW64( __in HANDLE hProcess, __inout PIMAGEHLP_LINEW64 Line #ifdef Crystal_TRANSLATE_TCHAR #define SymGetLineNext64 SymGetLineNextW64 #endif</code>
		/// </para>
		/// <para>
		/// This function supersedes the <c>SymGetLineNext</c> function. For more information, see Updated Platform Support.
		/// <c>SymGetLineNext</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetlinenext BOOL IMAGEAPI SymGetLineNext( HANDLE
		// hProcess, PIMAGEHLP_LINE Line );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetLineNext")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetlinenext64 BOOL IMAGEAPI SymGetLineNext64( HANDLE
		// hProcess, PIMAGEHLP_LINE64 Line );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Ansi, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetLineNext64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetlinenextw64 BOOL IMAGEAPI SymGetLineNextW64( HANDLE
		// hProcess, PIMAGEHLP_LINEW64 Line );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Unicode, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetLineNextW64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// <para>
		/// To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR. <c>SymGetLinePrevW64</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		/// <code>BOOL IMAGEAPI SymGetLinePrevW64( __in HANDLE hProcess, __inout PIMAGEHLP_LINEW64 Line ); #ifdef Crystal_TRANSLATE_TCHAR #define SymGetLinePrev64 SymGetLinePrevW64 #endif</code>
		/// </para>
		/// <para>
		/// This function supersedes the <c>SymGetLinePrev</c> function. For more information, see Updated Platform Support.
		/// <c>SymGetLinePrev</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetlineprev BOOL IMAGEAPI SymGetLinePrev( HANDLE
		// hProcess, PIMAGEHLP_LINE Line );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetLinePrev")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetlineprev64 BOOL IMAGEAPI SymGetLinePrev64( HANDLE
		// hProcess, PIMAGEHLP_LINE64 Line );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Ansi, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetLinePrev64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetlineprevw64 BOOL IMAGEAPI SymGetLinePrevW64( HANDLE
		// hProcess, PIMAGEHLP_LINEW64 Line );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Unicode, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetLinePrevW64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <c>SymGetModuleBase</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetmodulebase DWORD IMAGEAPI SymGetModuleBase( HANDLE
		// hProcess, DWORD dwAddr );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetModuleBase")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetmodulebase64 DWORD64 IMAGEAPI SymGetModuleBase64(
		// HANDLE hProcess, DWORD64 qwAddr );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetModuleBase64")]
		...
		/// </para>
		/// <para>
		/// The size of the IMAGEHLP_MODULE64 structure used by this function has changed over the years. If a version of Crystal.dll is
		/// called that is older than the Crystal.h used to compile the calling code, then this function may fail with an error code of
		/// <c>ERROR_INVALID_PARAMETER</c>. This most commonly occurs when the system version (%WinDir%\System32\Crystal.dll) is called.
		/// Code that calls the system version of Crystal.dll must be compiled using the appropriate SDK for that Windows release or the SDK
		/// for a previous release.
		/// </para>
		/// <para>
		/// The recommended model is to redistribute the required version of Crystal.dll along with the calling software. This allows the
		/// caller to use the most robust versions of Crystal.dll as well as a simplifying upgrades. The most recent version of Crystal.dll
		...
		/// </para>
		/// <para>
		/// To call the Unicode version of this function, define <c>Crystal_TRANSLATE_TCHAR</c>. <c>SymGetModuleInfoW64</c> is defined as
		/// follows in Crystal.h.
		/// </para>
		/// <para>
		/// <code> BOOL IMAGEAPI SymGetModuleInfoW64( __in HANDLE hProcess, __in DWORD64 qwAddr, __out PIMAGEHLP_MODULEW64 ModuleInfo ); #ifdef Crystal_TRANSLATE_TCHAR #define SymGetModuleInfo64 SymGetModuleInfoW64 #endif</code>
		/// </para>
		/// <para>
		/// This function supersedes the <c>SymGetModuleInfo</c> function. For more information, see Updated Platform Support.
		/// <c>SymGetModuleInfo</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetmoduleinfo BOOL IMAGEAPI SymGetModuleInfo( HANDLE
		// hProcess, DWORD dwAddr, PIMAGEHLP_MODULE ModuleInfo );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetModuleInfo")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetmoduleinfo64 BOOL IMAGEAPI SymGetModuleInfo64( HANDLE
		// hProcess, DWORD64 qwAddr, PIMAGEHLP_MODULE64 ModuleInfo );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Ansi, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetModuleInfo64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetomaps BOOL IMAGEAPI SymGetOmaps( HANDLE hProcess,
		// DWORD64 BaseOfDll, POMAP *OmapTo, PDWORD64 cOmapTo, POMAP *OmapFrom, PDWORD64 cOmapFrom );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetOmaps")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetoptions DWORD IMAGEAPI SymGetOptions();
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetOptions")]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetscope BOOL IMAGEAPI SymGetScope( HANDLE hProcess,
		// ULONG64 BaseOfDll, DWORD Index, PSYMBOL_INFO Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetScope")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsearchpath BOOL IMAGEAPI SymGetSearchPath( HANDLE
		// hProcess, PSTR SearchPath, DWORD SearchPathLength );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSearchPath")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsourcefile BOOL IMAGEAPI SymGetSourceFile( HANDLE
		// hProcess, ULONG64 Base, PCSTR Params, PCSTR FileSpec, PSTR FilePath, DWORD Size );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSourceFile")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>If the function fails, the return value is <c>FALSE</c>. To retrieve extended error information, call GetLastError.</para>
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsourcefilechecksum BOOL IMAGEAPI
		...
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSourceFileChecksum")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsourcefilefromtoken BOOL IMAGEAPI
		// SymGetSourceFileFromToken( HANDLE hProcess, PVOID Token, PCSTR Params, PSTR FilePath, DWORD Size );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSourceFileFromToken")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsourcefiletoken BOOL IMAGEAPI SymGetSourceFileToken(
		// HANDLE hProcess, ULONG64 Base, PCSTR FileSpec, PVOID *Token, DWORD *Size );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSourceFileToken")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsourcevarfromtoken BOOL IMAGEAPI
		// SymGetSourceVarFromToken( HANDLE hProcess, PVOID Token, PCSTR Params, PCSTR VarName, PSTR Value, DWORD Size );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSourceVarFromToken")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsymbolfile BOOL IMAGEAPI SymGetSymbolFile( HANDLE
		...
		/// <c>SymGetSymFromAddr</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsymfromaddr BOOL IMAGEAPI SymGetSymFromAddr( HANDLE
		// hProcess, DWORD dwAddr, PDWORD pdwDisplacement, PIMAGEHLP_SYMBOL Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true, CharSet = CharSet.Ansi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSymFromAddr")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsymfromaddr64 BOOL IMAGEAPI SymGetSymFromAddr64(
		// HANDLE hProcess, DWORD64 qwAddr, PDWORD64 pdwDisplacement, PIMAGEHLP_SYMBOL64 Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true, CharSet = CharSet.Ansi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSymFromAddr64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <c>SymGetSymFromName</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsymfromname BOOL IMAGEAPI SymGetSymFromName( HANDLE
		// hProcess, PCSTR Name, PIMAGEHLP_SYMBOL Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true, CharSet = CharSet.Ansi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSymFromName")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsymfromname64 BOOL IMAGEAPI SymGetSymFromName64(
		// HANDLE hProcess, PCSTR Name, PIMAGEHLP_SYMBOL64 Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true, CharSet = CharSet.Ansi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSymFromName64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// <para>
		/// To call the Unicode version of this function, define <c>Crystal_TRANSLATE_TCHAR</c>. <c>SymGetSymNextW64</c> is defined as
		/// follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// <c>SymGetSymNext</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsymnext BOOL IMAGEAPI SymGetSymNext( HANDLE hProcess,
		// PIMAGEHLP_SYMBOL Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSymNext")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsymnext64 BOOL IMAGEAPI SymGetSymNext64( HANDLE
		// hProcess, PIMAGEHLP_SYMBOL64 Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Ansi, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSymNext64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// <para>
		/// To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR. <c>SymGetSymPrevW64</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// <c>SymGetSymPrev</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsymprev BOOL IMAGEAPI SymGetSymPrev( HANDLE hProcess,
		// PIMAGEHLP_SYMBOL Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Unicode)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSymPrev")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgetsymprev64 BOOL IMAGEAPI SymGetSymPrev64( HANDLE
		// hProcess, PIMAGEHLP_SYMBOL64 Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Ansi, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetSymPrev64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgettypefromname BOOL IMAGEAPI SymGetTypeFromName( HANDLE
		// hProcess, ULONG64 BaseOfDll, PCSTR Name, PSYMBOL_INFO Symbol );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetTypeFromName")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgettypeinfo BOOL IMAGEAPI SymGetTypeInfo( HANDLE
		// hProcess, DWORD64 ModBase, ULONG TypeId, IMAGEHLP_SYMBOL_TYPE_INFO GetType, PVOID pInfo );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetTypeInfo")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symgettypeinfoex BOOL IMAGEAPI SymGetTypeInfoEx( HANDLE
		// hProcess, DWORD64 ModBase, PIMAGEHLP_GET_TYPE_INFO_PARAMS Params );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymGetTypeInfoEx")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-syminitialize BOOL IMAGEAPI SymInitialize( HANDLE hProcess,
		// PCSTR UserSearchPath, BOOL fInvadeProcess );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymInitialize")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <c>SymLoadModule</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symloadmodule DWORD IMAGEAPI SymLoadModule( HANDLE
		// hProcess, HANDLE hFile, PCSTR ImageName, PCSTR ModuleName, DWORD BaseOfDll, DWORD SizeOfDll );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymLoadModule")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symloadmodule64 DWORD64 IMAGEAPI SymLoadModule64( HANDLE
		// hProcess, HANDLE hFile, PCSTR ImageName, PCSTR ModuleName, DWORD64 BaseOfDll, DWORD SizeOfDll );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymLoadModule64")]
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symloadmoduleex DWORD64 IMAGEAPI SymLoadModuleEx( HANDLE
		// hProcess, HANDLE hFile, PCSTR ImageName, PCSTR ModuleName, DWORD64 BaseOfDll, DWORD DllSize, PMODLOAD_DATA Data, DWORD Flags );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymLoadModuleEx")]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symmatchfilename BOOL IMAGEAPI SymMatchFileName( PCSTR
		// FileName, PCSTR Match, PSTR *FileNameStop, PSTR *MatchStop );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymMatchFileName")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symmatchstring BOOL IMAGEAPI SymMatchString( PCSTR string,
		// PCSTR expression, BOOL fCase );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymMatchString")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symnext BOOL IMAGEAPI SymNext( HANDLE hProcess,
		// PSYMBOL_INFO si );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymNext")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symprev BOOL IMAGEAPI SymPrev( HANDLE hProcess,
		// PSYMBOL_INFO si );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymPrev")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symqueryinlinetrace BOOL IMAGEAPI SymQueryInlineTrace(
		...
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymQueryInlineTrace")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symrefreshmodulelist BOOL IMAGEAPI SymRefreshModuleList(
		// HANDLE hProcess );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymRefreshModuleList")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// <para>
		/// To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR. <c>SymRegisterCallbackW64</c> is defined as
		/// follows in Crystal.h.
		/// </para>
		/// <para>
		/// <code>BOOL IMAGEAPI SymRegisterCallbackW64( __in HANDLE hProcess, __in PSYMBOL_REGISTERED_CALLBACK64 CallbackFunction, __in ULONG64 UserContext ); #ifdef Crystal_TRANSLATE_TCHAR #define SymRegisterCallback64 SymRegisterCallbackW64 #endif</code>
		/// </para>
		/// <para>
		/// This function supersedes the <c>SymRegisterCallback</c> function. For more information, see Updated Platform Support.
		/// <c>SymRegisterCallback</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// <para>For a more extensive example, read Getting Notifications.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symregistercallback BOOL IMAGEAPI SymRegisterCallback(
		// HANDLE hProcess, PSYMBOL_REGISTERED_CALLBACK CallbackFunction, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymRegisterCallback")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>For a more extensive example, read Getting Notifications.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symregistercallback64 BOOL IMAGEAPI SymRegisterCallback64(
		// HANDLE hProcess, PSYMBOL_REGISTERED_CALLBACK64 CallbackFunction, ULONG64 UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Ansi, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymRegisterCallback64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>For a more extensive example, read Getting Notifications.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symregistercallbackw64 BOOL IMAGEAPI
		// SymRegisterCallbackW64( HANDLE hProcess, PSYMBOL_REGISTERED_CALLBACK64 CallbackFunction, ULONG64 UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Unicode, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymRegisterCallbackW64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// Support. <c>SymRegisterFunctionEntryCallback</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symregisterfunctionentrycallback BOOL IMAGEAPI
		// SymRegisterFunctionEntryCallback( HANDLE hProcess, PSYMBOL_FUNCENTRY_CALLBACK CallbackFunction, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymRegisterFunctionEntryCallback")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symregisterfunctionentrycallback64 BOOL IMAGEAPI
		// SymRegisterFunctionEntryCallback64( HANDLE hProcess, PSYMBOL_FUNCENTRY_CALLBACK64 CallbackFunction, ULONG64 UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymRegisterFunctionEntryCallback64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <param name="Index">A unique value for the symbol.</param>
		/// <param name="SymTag">
		/// The PDB classification. These values are defined in Crystal.h in the <c>SymTagEnum</c> enumeration type. For descriptions, see
		...
		/// <term>Include all symbols and other data in the .pdb files. Crystal 6.6 and earlier: This value is not supported.</term>
		/// </item>
		/// <item>
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsearch BOOL IMAGEAPI SymSearch( HANDLE hProcess, ULONG64
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsetcontext BOOL IMAGEAPI SymSetContext( HANDLE hProcess,
		// PIMAGEHLP_STACK_FRAME StackFrame, PIMAGEHLP_CONTEXT Context );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSetContext")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <term>SYMOPT_EX_DISABLEACCESSTIMEUPDATE 0</term>
		/// <term>
		/// When set to TRUE, turns off explicitly updating the last access time of a symbol that is loaded. By default, Crystal updates the
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsetextendedoption BOOL IMAGEAPI SymSetExtendedOption(
		// IMAGEHLP_EXTENDED_OPTIONS option, BOOL value );
		[DllImport(Lib_Crystal, SetLastError = false, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSetExtendedOption")]
		[return: MarshalAs(UnmanagedType.Bool)]
		public static extern bool SymSetExtendedOption(IMAGEHLP_EXTENDED_OPTIONS option, [MarshalAs(UnmanagedType.Bool)] bool value);

		/// <summary>Sets the home directory used by Crystal.</summary>
		/// <param name="hProcess">A handle to a process. This handle must have been previously passed to the SymInitialize function.</param>
		/// <param name="dir">
		...
		/// <remarks>
		/// <para>
		/// The default home directory is the directory in which Crystal.dll resides. Crystal uses this directory as a basis for other
		/// directories, such as the default downstream store directory (the sym subdirectory of the home directory).
		/// </para>
		/// <para>
		/// The home directory used for the default symbol store and the source server cache location is stored in the Crystal_HOMEDIR
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsethomedirectory PCHAR IMAGEAPI SymSetHomeDirectory(
		// HANDLE hProcess, PCSTR dir );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSetHomeDirectory")]
		...
		/// Crystal translates them to absolute addresses. There are symbols that are stored as an absolute address. These have very
		/// specialized purposes and are typically not used. Crystal 5.1 and earlier: This value is not supported.
		/// </term>
		/// </item>
		/// <item>
		/// <term>SYMOPT_ALLOW_ZERO_ADDRESS 0x01000000</term>
		/// <term>Enables the use of symbols that do not have an address. By default, Crystal filters out symbols that do not have an address.</term>
		/// </item>
		/// <item>
		...
		/// in the global symbols or within the current scope. This option has no effect with SYMOPT_PUBLICS_ONLY. Crystal 5.1 and earlier:
		/// This value is not supported.
		/// </term>
		/// </item>
		/// <item>
		...
		/// <term>
		/// Disables the auto-detection of symbol server stores in the symbol path, even without the "SRV*" designation, maintaining
		/// compatibility with previous behavior. Crystal 6.6 and earlier: This value is not supported.
		/// </term>
		/// </item>
		/// <item>
		...
		/// <term>Symbols are stored in the root directory of the default downstream store. Crystal 6.1 and earlier: This value is not supported.</term>
		/// </item>
		/// <item>
		...
		/// <term>Ignore the image directory. Crystal 6.1 and earlier: This value is not supported.</term>
		/// </item>
		/// <item>
		/// <term>SYMOPT_IGNORE_NT_SYMPATH 0x00001000</term>
		/// <term>
		/// Do not use the path specified by _NT_SYMBOL_PATH if the user calls SymSetSearchPath without a valid path. Crystal 5.1: This
		/// value is not supported.
		/// </term>
		/// </item>
		/// <item>
		...
		/// <term>
		/// Do not search the image for the symbol path when loading the symbols for a module if the module header cannot be read. Crystal
		...
		/// <term>
		/// Do not search the publics table for symbols. This option should have little effect because there are copies of the public
		/// symbols in the globals table. Crystal 5.1: This value is not supported.
		/// </term>
		/// </item>
		/// <item>
		...
		/// <term>Overwrite the downlevel store from the symbol store. Crystal 6.1 and earlier: This value is not supported.</term>
		/// </item>
		/// <item>
		/// <term>SYMOPT_PUBLICS_ONLY 0x00004000</term>
		/// <term>
		/// Do not use private symbols. The version of Crystal that shipped with earlier Windows release supported only public symbols; this
		/// option provides compatibility with this limitation. Crystal 5.1: This value is not supported.
		/// </term>
		/// </item>
		/// <item>
		...
		/// <term>
		/// Crystal will not load any symbol server other than SymSrv. SymSrv will not use the downstream store specified in
		/// _NT_SYMBOL_PATH. After this flag has been set, it cannot be cleared. Crystal 6.0 and 6.1: This flag can be cleared. Crystal 5.1:
		/// This value is not supported.
		/// </term>
		/// </item>
		/// <item>
		...
		/// <para>For an example, see Initializing the Symbol Handler.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsetoptions DWORD IMAGEAPI SymSetOptions( DWORD
		// SymOptions );
		[DllImport(Lib_Crystal, SetLastError = false, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSetOptions")]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsetparentwindow BOOL IMAGEAPI SymSetParentWindow( HWND
		// hwnd );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSetParentWindow")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsetscopefromaddr BOOL IMAGEAPI SymSetScopeFromAddr(
		// HANDLE hProcess, ULONG64 Address );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSetScopeFromAddr")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsetscopefromindex BOOL IMAGEAPI SymSetScopeFromIndex(
		// HANDLE hProcess, ULONG64 BaseOfDll, DWORD Index );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSetScopeFromIndex")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>If the function fails, the return value is <c>FALSE</c>. To retrieve extended error information, call GetLastError.</para>
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsetscopefrominlinecontext BOOL IMAGEAPI
		// SymSetScopeFromInlineContext( HANDLE hProcess, ULONG64 Address, ULONG InlineContext );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSetScopeFromInlineContext")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsetsearchpath BOOL IMAGEAPI SymSetSearchPath( HANDLE
		// hProcess, PCSTR SearchPath );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSetSearchPath")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsrvdeltaname PCSTR IMAGEAPI SymSrvDeltaName( HANDLE
		// hProcess, PCSTR SymPath, PCSTR Type, PCSTR File1, PCSTR File2 );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSrvDeltaName")]
		[return: MarshalAs(UnmanagedType.LPTStr)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsrvgetfileindexes BOOL IMAGEAPI SymSrvGetFileIndexes(
		// PCSTR File, GUID *Id, PDWORD Val1, PDWORD Val2, DWORD Flags );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSrvGetFileIndexes")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsrvgetfileindexinfo BOOL IMAGEAPI
		// SymSrvGetFileIndexInfo( PCSTR File, PSYMSRV_INDEX_INFO Info, DWORD Flags );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSrvGetFileIndexInfo")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsrvgetfileindexstring BOOL IMAGEAPI
		// SymSrvGetFileIndexString( HANDLE hProcess, PCSTR SrvPath, PCSTR File, PSTR Index, size_t Size, DWORD Flags );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSrvGetFileIndexString")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsrvgetsupplement PCSTR IMAGEAPI SymSrvGetSupplement(
		// HANDLE hProcess, PCSTR SymPath, PCSTR Node, PCSTR File );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSrvGetSupplement")]
		[return: MarshalAs(UnmanagedType.LPTStr)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsrvisstore BOOL IMAGEAPI SymSrvIsStore( HANDLE hProcess,
		// PCSTR path );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSrvIsStore")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsrvstorefile PCSTR IMAGEAPI SymSrvStoreFile( HANDLE
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symsrvstoresupplement PCSTR IMAGEAPI SymSrvStoreSupplement(
		// HANDLE hProcess, PCSTR SrvPath, PCSTR Node, PCSTR File, DWORD Flags );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymSrvStoreSupplement")]
		[return: MarshalAs(UnmanagedType.LPTStr)]
		...
		/// is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symundname BOOL IMAGEAPI SymUnDName( PIMAGEHLP_SYMBOL sym,
		// PSTR UnDecName, DWORD UnDecNameLength );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymUnDName")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symundname64 BOOL IMAGEAPI SymUnDName64( PIMAGEHLP_SYMBOL64
		// sym, PSTR UnDecName, DWORD UnDecNameLength );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymUnDName64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <c>SymUnloadedModule</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symunloadmodule BOOL IMAGEAPI SymUnloadModule( HANDLE
		// hProcess, DWORD BaseOfDll );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymUnloadModule")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// <para>For an example, see Unloading a Symbol Module.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-symunloadmodule64 BOOL IMAGEAPI SymUnloadModule64( HANDLE
		// hProcess, DWORD64 BaseOfDll );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SymUnloadModule64")]
		[return: MarshalAs(UnmanagedType.Bool)]
