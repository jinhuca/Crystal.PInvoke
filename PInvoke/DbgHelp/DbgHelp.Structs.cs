...
namespace Crystal.PInvoke
{
	...
	public static partial class Crystal
	{
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_DEFERRED_SYMBOL_LOAD64")]
		[Flags]
		public enum DSLFLAG
		{
			/// <summary/>
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_GET_TYPE_INFO_PARAMS")]
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._tagSTACKFRAME_EX")]
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_MODULE")]
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._SYMBOL_INFO")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-address typedef struct _tagADDRESS { DWORD Offset; WORD
		// Segment; ADDRESS_MODE Mode; } ADDRESS, *LPADDRESS;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._tagADDRESS")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-address64 typedef struct _tagADDRESS64 { DWORD64 Offset;
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-api_version typedef struct API_VERSION { USHORT
		// MajorVersion; USHORT MinorVersion; USHORT Revision; USHORT Reserved; } API_VERSION, *LPAPI_VERSION;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal.API_VERSION")]
		[StructLayout(LayoutKind.Sequential)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-image_debug_information typedef struct
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGE_DEBUG_INFORMATION")]
		[StructLayout(LayoutKind.Sequential)]
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_cba_event typedef struct _IMAGEHLP_CBA_EVENT {
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_cba_read_memory typedef struct
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_CBA_READ_MEMORY")]
		[StructLayout(LayoutKind.Sequential)]
		...
		/// Support. <c>IMAGEHLP_DEFERRED_SYMBOL_LOAD</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_deferred_symbol_load typedef struct
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_DEFERRED_SYMBOL_LOAD")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_deferred_symbol_load64 typedef struct
		...
		/// <c>IMAGEHLP_DUPLICATE_SYMBOL</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_duplicate_symbol64 typedef struct
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_DUPLICATE_SYMBOL64")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_get_type_info_params typedef struct
		...
		public struct IMAGEHLP_GET_TYPE_INFO_PARAMS
		{
			...
			/// symbol tag of <c>SymTagData</c>. For a list of tags, see the <c>SymTagEnum</c> type defined in Crystal.h
			/// </summary>
		...
		/// <c>IMAGEHLP_LINE</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_line typedef struct _IMAGEHLP_LINE { DWORD
		// SizeOfStruct; PVOID Key; DWORD LineNumber; PCHAR FileName; DWORD Address; } IMAGEHLP_LINE, *PIMAGEHLP_LINE;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_LINE")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_line64 typedef struct _IMAGEHLP_LINE64 { DWORD
		// SizeOfStruct; PVOID Key; DWORD LineNumber; PCHAR FileName; DWORD64 Address; } IMAGEHLP_LINE64, *PIMAGEHLP_LINE64;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_LINE64")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
		...
		/// <c>IMAGEHLP_MODULE</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_module typedef struct _IMAGEHLP_MODULE { DWORD
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_module64 typedef struct _IMAGEHLP_MODULE64 { DWORD
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_MODULE64")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
		public struct IMAGEHLP_MODULE64
		{
			...
			/// <para><c>Crystal 6.1 and earlier:</c> This member is not supported.</para>
			/// </summary>
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_stack_frame typedef struct _IMAGEHLP_STACK_FRAME {
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_STACK_FRAME")]
		[StructLayout(LayoutKind.Sequential)]
		...
		/// <c>IMAGEHLP_SYMBOL</c> is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_symbol typedef struct _IMAGEHLP_SYMBOL { DWORD
		// SizeOfStruct; DWORD Address; DWORD Size; DWORD Flags; DWORD MaxNameLength; CHAR Name[1]; } IMAGEHLP_SYMBOL, *PIMAGEHLP_SYMBOL;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_SYMBOL")]
		[CrystalMarshaler(typeof(SafeAnysizeStringMarshaler<IMAGEHLP_SYMBOL>), "Ansi")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
		...
		/// <summary>
		/// A marshaler implementation of <see cref="ICrystalMarshaler"/> that pulls a full string from a structure with a last field having
		/// one character.
		/// </summary>
		/// <typeparam name="T">The structure type to be marshaled.</typeparam>
		/// <seealso cref="Crystal.InteropServices.ICrystalMarshaler"/>
		public class SafeAnysizeStringMarshaler<T> : ICrystalMarshaler
		{
			...
			SafeAllocatedMemoryHandle ICrystalMarshaler.MarshalManagedToNative(object managedObject)
			{
			...
			object ICrystalMarshaler.MarshalNativeToManaged(IntPtr pNativeData, SizeT allocatedBytes)
			{
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_symbol64 typedef struct _IMAGEHLP_SYMBOL64 { DWORD
		// SizeOfStruct; DWORD64 Address; DWORD Size; DWORD Flags; DWORD MaxNameLength; CHAR Name[1]; } IMAGEHLP_SYMBOL64, *PIMAGEHLP_SYMBOL64;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_SYMBOL64")]
		[CrystalMarshaler(typeof(SafeAnysizeStringMarshaler<IMAGEHLP_SYMBOL64>), "Ansi")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
		...
		// SizeOfStruct; DWORD Address; DWORD Size; DWORD Flags; DWORD MaxNameLength; CHAR Name[1]; } IMAGEHLP_SYMBOL, *PIMAGEHLP_SYMBOL;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_SYMBOL")]
		[CrystalMarshaler(typeof(SafeAnysizeStringMarshaler<IMAGEHLP_SYMBOLW>), "Unicode")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-imagehlp_symbolw64 typedef struct _IMAGEHLP_SYMBOLW64 {
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_SYMBOLW64")]
		[CrystalMarshaler(typeof(SafeAnysizeStringMarshaler<IMAGEHLP_SYMBOLW64>), "Unicode")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-kdhelp typedef struct _KDHELP { DWORD Thread; DWORD
		...
		// } KDHELP, *PKDHELP;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._KDHELP")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-loaded_image typedef struct _LOADED_IMAGE { PSTR
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._LOADED_IMAGE")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-modload_cvmisc typedef struct _MODLOAD_CVMISC { DWORD oCV;
		// size_t cCV; DWORD oMisc; size_t cMisc; DWORD dtImage; DWORD cImage; } MODLOAD_CVMISC, *PMODLOAD_CVMISC;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._MODLOAD_CVMISC")]
		[StructLayout(LayoutKind.Sequential)]
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-modload_data typedef struct _MODLOAD_DATA { DWORD ssize;
		// DWORD ssig; PVOID data; DWORD size; DWORD flags; } MODLOAD_DATA, *PMODLOAD_DATA;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._MODLOAD_DATA")]
		[StructLayout(LayoutKind.Sequential)]
		...
		/// </list>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-omap typedef struct _OMAP { ULONG rva; ULONG rvaTo; } OMAP, *POMAP;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._OMAP")]
		[StructLayout(LayoutKind.Sequential)]
		public struct OMAP
		{
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-sourcefile typedef struct _SOURCEFILE { DWORD64 ModBase;
		// PCHAR FileName; } SOURCEFILE, *PSOURCEFILE;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._SOURCEFILE")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-srccodeinfo typedef struct _SRCCODEINFO { DWORD
		// SizeOfStruct; PVOID Key; DWORD64 ModBase; CHAR Obj[MAX_PATH + 1]; CHAR FileName[MAX_PATH + 1]; DWORD LineNumber; DWORD64 Address;
		// } SRCCODEINFO, *PSRCCODEINFO;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._SRCCODEINFO")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-stackframe64 typedef struct _tagSTACKFRAME64 { ADDRESS64
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._tagSTACKFRAME64")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-stackframe_ex typedef struct _tagSTACKFRAME_EX { ADDRESS64
		// AddrPC; ADDRESS64 AddrReturn; ADDRESS64 AddrFrame; ADDRESS64 AddrStack; ADDRESS64 AddrBStore; PVOID FuncTableEntry; DWORD64
		...
		/// <summary>Contains symbol information.</summary>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-symbol_info typedef struct _SYMBOL_INFO { ULONG
		...
		public struct SYMBOL_INFO
		{
			...
			/// <summary>The PDB classification. These values are defined in Crystal.h in the SymTagEnum enumeration type.</summary>
			public uint Tag;
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-symsrv_index_info typedef struct { DWORD sizeofstruct; char
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal.__unnamed_struct_0")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ns-Crystal-ti_findchildren_params typedef struct
		// _TI_FINDCHILDREN_PARAMS { ULONG Count; ULONG Start; ULONG ChildId[1]; } TI_FINDCHILDREN_PARAMS;
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._TI_FINDCHILDREN_PARAMS")]
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<TI_FINDCHILDREN_PARAMS>), nameof(Count))]
		[StructLayout(LayoutKind.Sequential)]
		...
		/// <summary>Contains symbol information.</summary>
		/// <seealso cref="Crystal.InteropServices.SafeHGlobalStruct{T}"/>
