...
namespace Crystal.PInvoke
{
	public static partial class Crystal
	{
		...
		public enum MINIDUMP_CALLBACK_TYPE
		{
			...
			/// be called again. Crystal 6.1 and earlier: This value is not supported.
			/// </summary>
			MemoryCallback,

			/// <summary>The callback function returns cancellation information. Crystal 6.1 and earlier: This value is not supported.</summary>
			CancelCallback,
			...
			/// and set the Handle member of the MINIDUMP_CALLBACK_OUTPUT structure. Crystal 6.1 and earlier: This value is not supported.
			/// </summary>
			WriteKernelMinidumpCallback,

			/// <summary>
			/// The callback function returns status information for the kernel minidump. Crystal 6.1 and earlier: This value is not supported.
			/// </summary>
			...
			/// callback will not be called again. Crystal 6.3 and earlier: This value is not supported.
			/// </summary>
			...
			/// FALSE or if Continue is FALSE, the callback will not be called for additional memory regions. Crystal 6.4 and earlier: This
			...
			/// caller will receive an IoWriteAllCallback callback for each piece of data. Crystal 6.4 and earlier: This value is not supported.
			/// </summary>
			IoStartCallback,
			...
			/// IoFinishCallback callback when the I/O has completed. Crystal 6.4 and earlier: This value is not supported.
			/// </summary>
			IoWriteAllCallback,

			/// <summary>
			/// The callback returns I/O completion information. If the callback returns FALSE or does not set the Status member of
			/// MINIDUMP_CALLBACK_OUTPUT to S_OK, the minidump library assumes the minidump write operation has failed. Crystal 6.4 and
			...
			/// failure to write to the minidump. Crystal 6.4 and earlier: This value is not supported.
			/// </summary>
			ReadMemoryFailureCallback,

			/// <summary>The callback returns secondary information. Crystal 6.5 and earlier: This value is not supported.</summary>
			SecondaryFlagsCallback,

			/// <summary>
			/// The callback function indicates whether the target is a process or a snapshot.Crystal 6.2 and earlier: This value is not supported.
			/// </summary>
			...
			/// value of S_OK means that virtual memory callbacks are not supported.Crystal 6.2 and earlier: This value is not supported.
			/// </summary>
			VmStartCallback,

			/// <summary>
			/// The callback function is invoked for snapshot targets to collect virtual address memory information from the target.The
			/// callback is only called if VmStartCallback returned a value of S_FALSE.Crystal 6.2 and earlier: This value is not supported.
			/// </summary>
			VmQueryCallback,
			...
			/// returned S_FALSE.Crystal 6.2 and earlier: This value is not supported.
			/// </summary>
			VmPreReadCallback,
			...
			/// The callback is only called if VmStartCallback returned S_FALSE.Crystal 6.2 and earlier: This value is not supported.
			/// </summary>
			VmPostReadCallback,
		}
		...
		public enum MINIDUMP_STREAM_TYPE
		{
			...
			/// MINIDUMP_UNLOADED_MODULE_LIST.Crystal 5.1: This value is not supported.
			/// </summary>
			UnloadedModuleListStream,

			/// <summary>
			/// The stream contains miscellaneous information. For more information, see MINIDUMP_MISC_INFO or MINIDUMP_MISC_INFO_2.Crystal
			...
			/// process from the VirtualQuery function. For more information, see MINIDUMP_MEMORY_INFO_LIST.Crystal 6.1 and earlier: This
			/// value is not supported.
			/// </summary>
			MemoryInfoListStream,

			/// <summary>
			/// The stream contains thread state information. For more information, see MINIDUMP_THREAD_INFO_LIST.Crystal 6.1 and earlier:
			/// This value is not supported.
			/// </summary>
			ThreadInfoListStream,

			/// <summary>
			/// This stream contains operation list information. For more information, see MINIDUMP_HANDLE_OPERATION_LIST.Crystal 6.4 and
			/// earlier: This value is not supported.
			/// </summary>
		...
		public enum MINIDUMP_TYPE
		{
			...
			/// Windows Server 2003 with SP1 and Windows XP with SP2.Crystal 5.1: This value is not supported.
			/// </summary>
			...
			/// significantly. Crystal 5.1: This value is not supported.
			/// </summary>
			...
			/// locating the image file and should be used only in special situations. Crystal 5.1: This value is not supported.
			/// </summary>
			MiniDumpFilterModulePaths = 0x00000080,

			/// <summary>
			/// Include complete per-process and per-thread information from the operating system. Crystal 5.1: This value is not supported.
			/// </summary>
			MiniDumpWithProcessThreadData = 0x00000100,

			/// <summary>Scan the virtual address space for PAGE_READWRITE memory to be included. Crystal 5.1: This value is not supported.</summary>
			...
			/// private information will be present. Crystal 6.1 and earlier: This value is not supported.
			/// </summary>
			MiniDumpWithoutOptionalData = 0x00000400,

			/// <summary>
			/// Include memory region information. For more information, see MINIDUMP_MEMORY_INFO_LIST. Crystal 6.1 and earlier: This value
			/// is not supported.
			/// </summary>
			MiniDumpWithFullMemoryInfo = 0x00000800,

			/// <summary>
			/// Include thread state information. For more information, see MINIDUMP_THREAD_INFO_LIST. Crystal 6.1 and earlier: This value
			/// is not supported.
			/// </summary>
			...
			/// the ModuleWriteCodeSegs enumeration value from MODULE_WRITE_FLAGS. Crystal 6.1 and earlier: This value is not supported.
			/// </summary>
			...
			/// <summary>
			/// Scans the virtual address space for PAGE_WRITECOPY memory to be included. Prior to Crystal 6.1: This value is not supported.
			/// </summary>
			...
			/// dump.Prior to Crystal 6.1: This value is not supported.
			/// </summary>
			...
			/// Crystal 6.1: This value is not supported.
			/// </summary>
			MiniDumpWithTokenInformation = 0x00040000,

			/// <summary>Adds module header related data. Prior to Crystal 6.1: This value is not supported.</summary>
			MiniDumpWithModuleHeaders = 0x00080000,

			/// <summary>Adds filter triage related data. Prior to Crystal 6.1: This value is not supported.</summary>
		...
		public enum MODULE_WRITE_FLAGS
		{
			...
			/// MiniDumpWriteDump function includes MiniDumpWithProcessThreadData.Crystal 6.1 and earlier: This value is not supported.
			/// </summary>
			...
			/// enumeration value from MINIDUMP_TYPE is set.Crystal 6.1 and earlier: This value is not supported.
			/// </summary>
		...
		public enum THREAD_WRITE_FLAGS
		{
			...
			/// to control which threads provide complete thread data in the minidump file.Crystal 5.1: This value is not supported.
			/// </summary>
			...
			/// MINIDUMP_THREAD_INFO.Crystal 6.1 and earlier: This value is not supported.
			/// </summary>
		...
		public struct MINIDUMP_CALLBACK_INPUT
		{
			...
			/// <para><c>Crystal 6.2 and earlier:</c> This member is not available.</para>
			/// </summary>
			...
			/// </para>
			/// <para><c>Crystal 6.4 and earlier:</c> This member is not available.</para>
			/// </summary>
			...
			/// <para><c>Crystal 6.5 and earlier:</c> This member is not available.</para>
			/// </summary>
