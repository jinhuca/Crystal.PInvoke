...
namespace Crystal.PInvoke
{
	...
	{
		private const string Lib_Crystal = "Crystal.dll";
		...
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-penumdirtree_callback PENUMDIRTREE_CALLBACK
		// PenumdirtreeCallback; BOOL PenumdirtreeCallback( PCSTR FilePath, PVOID CallerData ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PENUMDIRTREE_CALLBACK")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-penumloaded_modules_callback PENUMLOADED_MODULES_CALLBACK
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PENUMLOADED_MODULES_CALLBACK")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-penumloaded_modules_callbackw64
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PENUMLOADED_MODULES_CALLBACKW64")]
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-pfind_debug_file_callback PFIND_DEBUG_FILE_CALLBACK
		// PfindDebugFileCallback; BOOL PfindDebugFileCallback( HANDLE FileHandle, PCSTR FileName, PVOID CallerData ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PFIND_DEBUG_FILE_CALLBACK")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-pfind_exe_file_callback PFIND_EXE_FILE_CALLBACK
		// PfindExeFileCallback; BOOL PfindExeFileCallback( HANDLE FileHandle, PCSTR FileName, PVOID CallerData ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PFIND_EXE_FILE_CALLBACK")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-pfunction_table_access_routine
		...
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PFUNCTION_TABLE_ACCESS_ROUTINE")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-pfunction_table_access_routine64
		...
		// AddrBase ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PFUNCTION_TABLE_ACCESS_ROUTINE64")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-pget_module_base_routine PGET_MODULE_BASE_ROUTINE
		// PgetModuleBaseRoutine; DWORD PgetModuleBaseRoutine( HANDLE hProcess, DWORD Address ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PGET_MODULE_BASE_ROUTINE")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-pget_module_base_routine64 PGET_MODULE_BASE_ROUTINE64
		// PgetModuleBaseRoutine64; DWORD64 PgetModuleBaseRoutine64( HANDLE hProcess, DWORD64 Address ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PGET_MODULE_BASE_ROUTINE64")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-pread_process_memory_routine PREAD_PROCESS_MEMORY_ROUTINE
		...
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PREAD_PROCESS_MEMORY_ROUTINE")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-psym_enummodules_callback PSYM_ENUMMODULES_CALLBACK
		// PsymEnummodulesCallback; BOOL PsymEnummodulesCallback( PCSTR ModuleName, ULONG BaseOfDll, PVOID UserContext ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi, CharSet = CharSet.Ansi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PSYM_ENUMMODULES_CALLBACK")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/id-id/windows/win32/api/Crystal/nc-Crystal-psym_enummodules_callback64 PSYM_ENUMMODULES_CALLBACK64
		// PsymEnummodulesCallback64; BOOL PsymEnummodulesCallback64( PCSTR ModuleName, DWORD64 BaseOfDll, PVOID UserContext ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PSYM_ENUMMODULES_CALLBACK64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/vi-vn/windows/win32/api/Crystal/nc-Crystal-ptranslate_address_routine64 PTRANSLATE_ADDRESS_ROUTINE64
		// PtranslateAddressRoutine64; DWORD64 PtranslateAddressRoutine64( HANDLE hProcess, HANDLE hThread, LPADDRESS64 lpaddr ) {...}
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PTRANSLATE_ADDRESS_ROUTINE64")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nc-Crystal-ptranslate_address_routine
		...
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		[PInvokeData("Crystal.h", MSDNShortId = "NC:Crystal.PTRANSLATE_ADDRESS_ROUTINE")]
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._tagADDRESS64")]
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NS:Crystal._IMAGEHLP_CBA_EVENT")]
		...
		/// </summary>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ne-Crystal-imagehlp_extended_options typedef enum {
		// SYMOPT_EX_DISABLEACCESSTIMEUPDATE, SYMOPT_EX_LASTVALIDDEBUGDIRECTORY, SYMOPT_EX_MAX } IMAGEHLP_EXTENDED_OPTIONS;
		[PInvokeData("Crystal.h", MSDNShortId = "NE:Crystal.__unnamed_enum_4")]
		public enum IMAGEHLP_EXTENDED_OPTIONS
		{
			/// <summary>
			/// Turns off explicit updates to the last access time of a symbol that is loaded. By default, Crystal updates the last access
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/ne-Crystal-imagehlp_symbol_type_info typedef enum
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NE:Crystal._IMAGEHLP_SYMBOL_TYPE_INFO")]
		public enum IMAGEHLP_SYMBOL_TYPE_INFO
		{
			...
			/// <summary>
			/// Indicates whether the user-defined data type is an indirect virtual base.The data type is BOOL.Crystal 6.6 and earlier: This
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.StackWalkEx")]
		[Flags]
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.UnDecorateSymbolName")]
		[Flags]
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-enumdirtree BOOL IMAGEAPI EnumDirTree( HANDLE hProcess,
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.EnumDirTree")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// <para>
		/// To call the Unicode version of this function, EnumerateLoadedModulesW64, define <c>Crystal_TRANSLATE_TCHAR</c>.
		/// EnumerateLoadedModulesW64 is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		/// <code>BOOL IMAGEAPI EnumerateLoadedModulesW64( __in HANDLE hProcess, __in PENUMLOADED_MODULES_CALLBACKW64 EnumLoadedModulesCallback, __in PVOID UserContext ); #ifdef Crystal_TRANSLATE_TCHAR #define EnumerateLoadedModules64 EnumerateLoadedModulesW64 #endif</code>
		/// </para>
		/// <para>
		/// This function supersedes the EnumerateLoadedModules function. For more information, see Updated Platform Support.
		/// EnumerateLoadedModules is defined as follows in Crystal.h.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-enumerateloadedmodules BOOL IMAGEAPI
		...
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.EnumerateLoadedModules")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </returns>
		/// <remarks>
		/// <para>All Crystal functions, such as this one, are single threaded. Therefore, calls from more than one thread to this function will likely result in unexpected behavior or memory corruption. To avoid this, you must synchronize all concurrent calls from more than one thread to this function.</para>
		/// <para>To call the Unicode version of this function, EnumerateLoadedModulesW64, define <c>Crystal_TRANSLATE_TCHAR</c>. EnumerateLoadedModulesW64 is defined as follows in Crystal.h.</para>
		/// <para><code>BOOL IMAGEAPI EnumerateLoadedModulesW64( __in HANDLE hProcess, __in PENUMLOADED_MODULES_CALLBACKW64 EnumLoadedModulesCallback, __in PVOID UserContext ); #ifdef Crystal_TRANSLATE_TCHAR #define EnumerateLoadedModules64 EnumerateLoadedModulesW64 #endif </code></para>
		/// <para>This function supersedes the EnumerateLoadedModules function. For more information, see Updated Platform Support. EnumerateLoadedModules is defined as follows in Crystal.h.</para>
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-enumerateloadedmodules64
		...
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Unicode, EntryPoint = "EnumerateLoadedModulesW64")]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.EnumerateLoadedModules64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		public static IList<(string ModuleName, IntPtr ModuleBase, uint ModuleSize)> EnumerateLoadedModules(HPROCESS hProcess)
		{
			...
			if (InteropServices.LibHelper.Is64BitProcess)
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-enumerateloadedmodulesexw BOOL IMAGEAPI
		// EnumerateLoadedModulesExW( HANDLE hProcess, PENUMLOADED_MODULES_CALLBACKW64 EnumLoadedModulesCallback, PVOID UserContext );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Unicode, EntryPoint = "EnumerateLoadedModulesExW")]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.EnumerateLoadedModulesExW")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-finddebuginfofile HANDLE IMAGEAPI FindDebugInfoFile( PCSTR
		// FileName, PCSTR SymbolPath, PSTR DebugFilePath );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.FindDebugInfoFile")]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-finddebuginfofileex HANDLE IMAGEAPI FindDebugInfoFileEx(
		// PCSTR FileName, PCSTR SymbolPath, PSTR DebugFilePath, PFIND_DEBUG_FILE_CALLBACK Callback, PVOID CallerData );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.FindDebugInfoFileEx")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-findexecutableimage HANDLE IMAGEAPI FindExecutableImage(
		// PCSTR FileName, PCSTR SymbolPath, PSTR ImageFilePath );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.FindExecutableImage")]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-findexecutableimageex HANDLE IMAGEAPI
		...
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.FindExecutableImageEx")]
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-getsymloaderror DWORD IMAGEAPI GetSymLoadError();
		[DllImport(Lib_Crystal, SetLastError = false, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.GetSymLoadError")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-gettimestampforloadedlibrary DWORD IMAGEAPI
		// GetTimestampForLoadedLibrary( HMODULE Module );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.GetTimestampForLoadedLibrary")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-imagedirectoryentrytodata PVOID IMAGEAPI
		// ImageDirectoryEntryToData( PVOID Base, BOOLEAN MappedAsImage, USHORT DirectoryEntry, PULONG Size );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.ImageDirectoryEntryToData")]
		...
		/// </para>
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-imagedirectoryentrytodataex PVOID IMAGEAPI
		// ImageDirectoryEntryToDataEx( PVOID Base, BOOLEAN MappedAsImage, USHORT DirectoryEntry, PULONG Size, PIMAGE_SECTION_HEADER
		// *FoundHeader );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.ImageDirectoryEntryToDataEx")]
		...
		/// <summary>
		/// <para>Retrieves the version information of the Crystal library installed on the system.</para>
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-imagehlpapiversion LPAPI_VERSION IMAGEAPI ImagehlpApiVersion();
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.ImagehlpApiVersion")]
		public static API_VERSION ImagehlpApiVersion() => ImagehlpApiVersionInternal().ToStructure<API_VERSION>();

		[DllImport(Lib_Crystal, SetLastError = false, EntryPoint = "ImagehlpApiVersion")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-imagehlpapiversionex LPAPI_VERSION IMAGEAPI
		// ImagehlpApiVersionEx( LPAPI_VERSION AppVersion );
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.ImagehlpApiVersionEx")]
		...
		[DllImport(Lib_Crystal, SetLastError = false, EntryPoint = "ImagehlpApiVersionEx")]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-imagentheader PIMAGE_NT_HEADERS IMAGEAPI ImageNtHeader(
		// PVOID Base );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.ImageNtHeader")]
		...
		/// than one thread to this function.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-imagervatosection PIMAGE_SECTION_HEADER IMAGEAPI
		// ImageRvaToSection( PIMAGE_NT_HEADERS NtHeaders, PVOID Base, ULONG Rva );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.ImageRvaToSection")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-imagervatova PVOID IMAGEAPI ImageRvaToVa( PIMAGE_NT_HEADERS
		// NtHeaders, PVOID Base, ULONG Rva, OUT PIMAGE_SECTION_HEADER *LastRvaSection );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.ImageRvaToVa")]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-makesuredirectorypathexists BOOL IMAGEAPI
		// MakeSureDirectoryPathExists( PCSTR DirPath );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.MakeSureDirectoryPathExists")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-mapdebuginformation PIMAGE_DEBUG_INFORMATION IMAGEAPI
		// MapDebugInformation( HANDLE FileHandle, PCSTR FileName, PCSTR SymbolPath, ULONG ImageBase );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.MapDebugInformation")]
		...
		/// <para>To call the Unicode version of this function, define Crystal_TRANSLATE_TCHAR.</para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-searchtreeforfile BOOL IMAGEAPI SearchTreeForFile( PCSTR
		// RootPath, PCSTR InputPathName, PSTR OutputPathBuffer );
		[DllImport(Lib_Crystal, SetLastError = true, CharSet = CharSet.Auto)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SearchTreeForFile")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-setsymloaderror void IMAGEAPI SetSymLoadError( DWORD error );
		[DllImport(Lib_Crystal, SetLastError = false, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.SetSymLoadError")]
		...
		/// <para>All Crystal functions, such as this one, are single threaded. Therefore, calls from more than one thread to this function will likely result in unexpected behavior or memory corruption. To avoid this, you must synchronize all concurrent calls from more than one thread to this function.</para>
		/// <para>This function supersedes the <c>StackWalk</c> function. For more information, see Updated Platform Support. <c>StackWalk</c> is defined as follows in Crystal.h.</para>
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-stackwalk
		...
		[DllImport(Lib_Crystal, SetLastError = false, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.StackWalk")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-stackwalk64 BOOL IMAGEAPI StackWalk64( DWORD MachineType,
		...
		[DllImport(Lib_Crystal, SetLastError = false, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.StackWalk64")]
		[return: MarshalAs(UnmanagedType.Bool)]
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-stackwalkex BOOL IMAGEAPI StackWalkEx( DWORD MachineType,
		...
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-undecoratesymbolname DWORD IMAGEAPI UnDecorateSymbolName(
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/Crystal/nf-Crystal-unmapdebuginformation BOOL IMAGEAPI UnmapDebugInformation(
		// PIMAGE_DEBUG_INFORMATION DebugInfo );
		[DllImport(Lib_Crystal, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("Crystal.h", MSDNShortId = "NF:Crystal.UnmapDebugInformation")]
		[return: MarshalAs(UnmanagedType.Bool)]
