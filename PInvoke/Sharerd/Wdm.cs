...
#pragma warning restore IDE1006 // Naming Styles
	...
	[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<CM_PARTIAL_RESOURCE_LIST>), nameof(Count))]
	[StructLayout(LayoutKind.Sequential)]
	...
	[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<CM_RESOURCE_LIST>), nameof(Count))]
	[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
	...
	public struct DEVICE_CAPABILITIES
	{
		...
		public bool DeviceD1 { get => Crystal.Extensions.BitHelper.GetBit(_flags, 0); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 0, value); }

		/// <summary>Specifies whether the device hardware supports the D2 power state. Drivers should not change this value.</summary>
		public bool DeviceD2 { get => Crystal.Extensions.BitHelper.GetBit(_flags, 1); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 1, value); }
		...
		/// </summary>
		public bool LockSupported { get => Crystal.Extensions.BitHelper.GetBit(_flags, 2); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 2, value); }
		...
		/// </summary>
		public bool EjectSupported { get => Crystal.Extensions.BitHelper.GetBit(_flags, 3); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 3, value); }
		...
		/// </para>
		/// </summary>
		public bool Removable { get => Crystal.Extensions.BitHelper.GetBit(_flags, 4); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 4, value); }

		/// <summary>Specifies whether the device is a docking peripheral.</summary>
		public bool DockDevice { get => Crystal.Extensions.BitHelper.GetBit(_flags, 5); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 5, value); }
		...
		/// </summary>
		public bool UniqueID { get => Crystal.Extensions.BitHelper.GetBit(_flags, 6); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 6, value); }
		...
		/// </summary>
		public bool SilentInstall { get => Crystal.Extensions.BitHelper.GetBit(_flags, 7); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 7, value); }
		...
		/// </summary>
		public bool RawDeviceOK { get => Crystal.Extensions.BitHelper.GetBit(_flags, 8); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 8, value); }
		...
		/// </para>
		/// </summary>
		public bool SurpriseRemovalOK { get => Crystal.Extensions.BitHelper.GetBit(_flags, 9); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 9, value); }
		...
		/// </summary>
		public bool WakeFromD0 { get => Crystal.Extensions.BitHelper.GetBit(_flags, 10); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 10, value); }
		...
		/// </summary>
		public bool WakeFromD1 { get => Crystal.Extensions.BitHelper.GetBit(_flags, 11); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 11, value); }
		...
		/// </summary>
		public bool WakeFromD2 { get => Crystal.Extensions.BitHelper.GetBit(_flags, 12); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 12, value); }
		...
		/// </summary>
		public bool WakeFromD3 { get => Crystal.Extensions.BitHelper.GetBit(_flags, 13); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 13, value); }
		...
		/// </para>
		/// </summary>
		public bool HardwareDisabled { get => Crystal.Extensions.BitHelper.GetBit(_flags, 14); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 14, value); }

		/// <summary>Reserved for future use.</summary>
		public bool NonDynamic { get => Crystal.Extensions.BitHelper.GetBit(_flags, 15); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 15, value); }

		/// <summary>Reserved for future use.</summary>
		public bool WarmEjectSupported { get => Crystal.Extensions.BitHelper.GetBit(_flags, 16); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 16, value); }
		...
		/// </summary>
		public bool NoDisplayInUI { get => Crystal.Extensions.BitHelper.GetBit(_flags, 17); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 17, value); }

		/// <summary>Reserved for system use.</summary>
		public bool Reserved1 { get => Crystal.Extensions.BitHelper.GetBit(_flags, 18); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 18, value); }
		...
		/// </summary>
		public bool WakeFromInterrupt { get => Crystal.Extensions.BitHelper.GetBit(_flags, 19); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 19, value); }

		/// <summary>Indicates whether the device is a secure device.</summary>
		public bool SecureDevice { get => Crystal.Extensions.BitHelper.GetBit(_flags, 20); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 20, value); }

		/// <summary>For a VGA device, indicates whether the parent bridge has the VGA decoding bit set.</summary>
		public bool ChildOfVgaEnabledBridge { get => Crystal.Extensions.BitHelper.GetBit(_flags, 21); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 21, value); }

		/// <summary>Indictates whether the device has IO decode enabled on boot.</summary>
		public bool DecodeIoOnBoot { get => Crystal.Extensions.BitHelper.GetBit(_flags, 22); set => Crystal.Extensions.BitHelper.SetBit(ref _flags, 22, value); }
