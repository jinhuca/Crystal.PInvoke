...
namespace Crystal.InteropServices
{
	...
	/// <summary>
	/// A marshaler implementation of <see cref="ICrystalMarshaler"/> to set the marshaler as an attribute using <see
	...
	public class SafeAnysizeStructMarshaler<T> : ICrystalMarshaler
	{
		...
		SizeT ICrystalMarshaler.GetNativeSize() => Marshal.SizeOf(typeof(T));
	...
	/// <summary>
	/// A marshaler implementation of <see cref="ICrystalMarshaler"/> to marshal structures whose last field is a character array of length
	...
	/// </summary>
	/// <typeparam name="T">The structure type to be marshaled.</typeparam>
	public class AnySizeStringMarshaler<T> : ICrystalMarshaler
	{
		...
		SizeT ICrystalMarshaler.GetNativeSize() => baseSz;
