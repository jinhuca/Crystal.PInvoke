...
namespace Crystal.PInvoke
{
	public static partial class User32
	{
		...
		[CrystalMarshaler(typeof(AnySizeStringMarshaler<DEV_BROADCAST_DEVICEINTERFACE>), "*")]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DEV_BROADCAST_HANDLE>), "*")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
		...
		[CrystalMarshaler(typeof(AnySizeStringMarshaler<DEV_BROADCAST_PORT>), "*")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
		...
		/// <summary>Undocumented.</summary>
		[PInvokeData("dbt.h")]
		[CrystalMarshaler(typeof(AnySizeStringMarshaler<DEV_BROADCAST_USERDEFINED>), "*")]
