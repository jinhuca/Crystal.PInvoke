...
using static Crystal.PInvoke.PortableDeviceApi;

namespace Crystal.Extensions
{
    /// <summary>Extension methods for classes in Crystal.PInvoke.PortableDeviceApi.</summary>
    public static class PortableDeviceExtensions
    {
        ...
        /// <param name="parentType">The type in which <paramref name="cmd"/> is defined, if not other than <see cref="Crystal.PInvoke.PortableDeviceApi"/>.</param>
        ...
        /// </param>
        /// <param name="parentType">The type in which <paramref name="key"/> is defined, if not other than <see cref="Crystal.PInvoke.PortableDeviceApi"/>.</param>
        /// <returns>
        ...
        public static bool TryGetCommandInfo(this PROPERTYKEY key, out WPDCommandAttribute cmd, out WPDCommandParamAttribute[] param, out WPDCommandResultAttribute[] result, Type parentType = null)
        {
            ...
            parentType ??= typeof(Crystal.PInvoke.PortableDeviceApi);
            if (pi is not null)
            {
