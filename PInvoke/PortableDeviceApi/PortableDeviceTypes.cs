...
namespace Crystal.PInvoke
{
    public static partial class PortableDeviceApi
    {
        ...
        public static IEnumerable<PROPERTYKEY> Enumerate(this IPortableDeviceKeyCollection intf) =>
            new Crystal.Collections.IEnumFromIndexer<PROPERTYKEY>(intf.GetCount, intf.GetAt);
        ...
        public static IEnumerable<PROPVARIANT> Enumerate(this IPortableDevicePropVariantCollection intf) =>
            new Crystal.Collections.IEnumFromIndexer<PROPVARIANT>(intf.GetCount, i => { PROPVARIANT pv = new(); intf.GetAt(i, pv); return pv; });
        ...
        public static IEnumerable<(PROPERTYKEY, PROPVARIANT)> Enumerate(this IPortableDeviceValues intf) =>
            new Crystal.Collections.IEnumFromIndexer<(PROPERTYKEY, PROPVARIANT)>(intf.GetCount, i => { PROPVARIANT pv = new(); intf.GetAt(i, out PROPERTYKEY pk, pv); return (pk, pv); });
        ...
        public static IEnumerable<IPortableDeviceValues> Enumerate(this IPortableDeviceValuesCollection intf) =>
            new Crystal.Collections.IEnumFromIndexer<IPortableDeviceValues>(intf.GetCount, intf.GetAt);
