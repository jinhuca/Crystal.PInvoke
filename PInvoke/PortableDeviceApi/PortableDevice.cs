...
namespace Crystal.PInvoke
{
    public static partial class PortableDeviceApi
    {
        ...
        /// WPD services. To register for specific Crystal of services, client should use the service category or service implements Guid.
        /// </summary>
        ...
        ****************************************************************************/
        ...
        /**************************************************************************** 
        * This section defines all WPD Functional Crystal
        ****************************************************************************/
        ...
        ****************************************************************************/
        ...
        //
        // WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_FUNCTIONAL_Crystal 
        // This command is used by clients to query the functional Crystal supported by the driver. 
        // Access:
        // FILE_READ_ACCESS
        // Parameters:
        // None
        // Results:
        // [ Required ] WPD_PROPERTY_CAPABILITIES_FUNCTIONAL_Crystal 
        [WPDCommand]
        [WPDCommandResult(nameof(WPD_PROPERTY_CAPABILITIES_FUNCTIONAL_Crystal), true)]
        public static PROPERTYKEY WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_FUNCTIONAL_Crystal => new(new(0x0CABEC78, 0x6B74, 0x41C6, 0x92, 0x16, 0x26, 0x39, 0xD1, 0xFC, 0xE3, 0x56), 4);
        //
        ...
        /// <summary>[ VT_UNKNOWN ] An IPortableDevicePropVariantCollection of type VT_CLSID which indicates the functional Crystal supported by the driver.</summary>
        [CorrespondingType(typeof(IPortableDevicePropVariantCollection))]
        public static PROPERTYKEY WPD_PROPERTY_CAPABILITIES_FUNCTIONAL_Crystal => new(new(0x0CABEC78, 0x6B74, 0x41C6, 0x92, 0x16, 0x26, 0x39, 0xD1, 0xFC, 0xE3, 0x56), 1004);
