...
namespace Crystal.PInvoke
{
    ...
    public static partial class PortableDeviceApi
    {
        ...
        public interface IEnumPortableDeviceObjectIDs : Crystal.Collections.ICOMEnum<string>
        {
        ...
        public interface IPortableDeviceCapabilities
        {
            ...
            /// <summary>The <c>GetFunctionalCrystal</c> method retrieves all functional Crystal supported by the device.</summary>
            /// <returns>
            /// An IPortableDevicePropVariantCollection interface that holds all the functional Crystal for this device. The values will
            /// be <c>GUID</c> s of type VT_CLSID in the retrieved <c>PROPVARIANT</c> values. The caller must release this interface when it
            /// is done with it.
            /// </returns>
            /// <remarks>
            /// <para>
            /// Functional Crystal describe the types of functions that a device can perform, such as image capture, audio capture, and
            ...
            /// </para>
            /// <para>Examples</para>
            /// <para>For an example of how to use this method see Retrieving the Functional Crystal Supported by a Device.</para>
            /// </remarks>
            // https://docs.microsoft.com/en-us/windows/win32/api/portabledeviceapi/nf-portabledeviceapi-iportabledevicecapabilities-getfunctionalCrystal
            // HRESULT GetFunctionalCrystal( [out] IPortableDevicePropVariantCollection **ppCrystal );
            IPortableDevicePropVariantCollection GetFunctionalCrystal();
            ...
            /// </summary>
            /// <param name="Category">
            /// A <c>REFGUID</c> that specifies a functional object category. To get a list of functional Crystal on the device, call IPortableDeviceCapabilities::GetFunctionalCrystal.
            /// </param>
            /// <returns>
        ...
        public static IEnumerable<string> Enumerate(this IEnumPortableDeviceObjectIDs intf) =>
            new Crystal.Collections.IEnumFromCom<string>(intf.Next, intf.Reset);
