...
#Disable Warning BC40000 ' Obsolete LPStruct
    ...
    Public Interface INetFwProduct
        ...
        ''' <summary>
        ''' <para>
        ''' For a third-party firewall product registration, indicates the rule Crystal for which the third-party firewall wishes to take
        ''' ownership from Windows Firewall.
        ''' </para>
        ''' <para>This property Is read/write.</para>
        ''' </summary>
        <DispId(1)>
        Property RuleCrystal As <MarshalAs(UnmanagedType.Struct)> Object
