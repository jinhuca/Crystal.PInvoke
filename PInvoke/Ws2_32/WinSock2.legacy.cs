...
namespace Crystal.PInvoke
{
	...
	public static partial class Ws2_32
	{
		...
		[CrystalMarshaler(typeof(SERVENT))]
		public struct SERVENT : ICrystalMarshaler
		{
			...
			SizeT ICrystalMarshaler.GetNativeSize() => IntPtr.Size == 8 ? Marshal.SizeOf(typeof(SERVENTx64)) : Marshal.SizeOf(typeof(SERVENT));
			...
			object ICrystalMarshaler.MarshalNativeToManaged(IntPtr pNativeData, SizeT allocatedBytes) => FromIntPtr(pNativeData);
