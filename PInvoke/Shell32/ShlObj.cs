...
using static Crystal.Extensions.BitHelper;
using static Crystal.PInvoke.ComCtl32;
using static Crystal.PInvoke.Kernel32;
using static Crystal.PInvoke.Ole32;
using static Crystal.PInvoke.ShlwApi;
...
namespace Crystal.PInvoke
{
	...
	public static partial class Shell32
	{
		...
		public enum SHGetDataFormat
		{
			...
			/// defined in the <c>Crystal.PInvoke.Mpr</c> library.
			/// </summary>
			// [CorrespondingType(typeof(Crystal.PInvoke.Mpr.NETRESOURCE), CorrepsondingAction.Get)] -- Chose not to link Mpr library just for this.
