...
using static Crystal.PInvoke.Ws2_32;
using DNS_STATUS = Crystal.PInvoke.Win32Error;
using IP4_ADDRESS = Crystal.PInvoke.Ws2_32.IN_ADDR;
using IP6_ADDRESS = Crystal.PInvoke.Ws2_32.IN6_ADDR;
...
namespace Crystal.PInvoke
{
	...
	public static partial class DnsApi
	{
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_ADDR_ARRAY>), nameof(AddrCount))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_DHCID_DATA>), nameof(dwByteCount))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_DS_DATA>), nameof(wDigestLength))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_KEY_DATA>), nameof(wKeyLength))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(DNS_MESSAGE_BUFFER_Marshaler))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_NSEC_DATA>), nameof(wTypeBitMapsLength))]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
		...
		/// <summary>Undocumented.</summary>
		[PInvokeData("windns.h")]
		[CrystalMarshaler(typeof(SafeDNS_NSEC3_DATAMarshaler))]
		[StructLayout(LayoutKind.Sequential)]
		...
		/// <summary>Undocumented.</summary>
		[PInvokeData("windns.h")]
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_NSEC3PARAM_DATA>), nameof(bSaltLength))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_NULL_DATA>), nameof(dwByteCount))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_NXT_DATA>), nameof(wNumTypes))]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_OPT_DATA>), nameof(wDataLength))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_SIG_DATA>), nameof(wSignatureLength))]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
		...
		/// <summary>Undocumented.</summary>
		[PInvokeData("windns.h")]
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_TLSA_DATA>), nameof(bCertificateAssociationDataLength))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_TXT_DATA>), nameof(dwStringCount))]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
		...
		/// <summary>Undocumented.</summary>
		[PInvokeData("windns.h")]
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_UNKNOWN_DATA>), nameof(dwByteCount))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[PInvokeData("windns.h", MSDNShortId = "df41c397-e662-42b4-9193-6776f9071898")]
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DNS_WINS_DATA>), nameof(cWinsServerCount))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<IP4_ARRAY>), nameof(AddrCount))]
		[StructLayout(LayoutKind.Sequential)]
		...
		internal class DNS_MESSAGE_BUFFER_Marshaler : ICrystalMarshaler
		{
			public DNS_MESSAGE_BUFFER_Marshaler()
			{
			}

			SizeT ICrystalMarshaler.GetNativeSize() => Marshal.SizeOf(typeof(DNS_MESSAGE_BUFFER));

			SafeAllocatedMemoryHandle ICrystalMarshaler.MarshalManagedToNative(object managedObject) => SafeCoTaskMemHandle.Null;
		...
		internal class SafeDNS_NSEC3_DATAMarshaler : ICrystalMarshaler
		{
			...
			SizeT ICrystalMarshaler.GetNativeSize() => Marshal.SizeOf(typeof(DNS_NSEC3_DATA));
