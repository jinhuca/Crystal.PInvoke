...
namespace Crystal.PInvoke
{
	...
	public static partial class Rpc
	{
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<RPC_BINDING_VECTOR>), nameof(Count))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<RPC_STATS_VECTOR>), nameof(Count))]
		[StructLayout(LayoutKind.Sequential)]
		...
		public struct SEC_WINNT_AUTH_IDENTITY
		{
			...
			private static readonly SEC_WINNT_AUTH_IDENTITY_CHARSET OsCharSet = Crystal.Extensions.StringHelper.GetCharSize() == 1 ? SEC_WINNT_AUTH_IDENTITY_CHARSET.SEC_WINNT_AUTH_IDENTITY_ANSI : SEC_WINNT_AUTH_IDENTITY_CHARSET.SEC_WINNT_AUTH_IDENTITY_UNICODE;
		}
