...
namespace Crystal.PInvoke
{
	...
	public static partial class WlanApi
	{
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DOT11_BSSID_LIST>), nameof(uTotalNumOfEntries))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<WLAN_AUTH_CIPHER_PAIR_LIST>), nameof(dwNumberOfItems))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[PInvokeData("wlanapi.h", MSDNShortId = "64343c1f-3543-406f-a64c-94196b8aa17e")]
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<WLAN_COUNTRY_OR_REGION_STRING_LIST>), nameof(dwNumberOfItems))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<WLAN_DEVICE_SERVICE_NOTIFICATION_DATA>), nameof(dwDataSize))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<WLAN_RAW_DATA_LIST>), nameof(dwNumberOfItems))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<WLAN_STATISTICS>), nameof(dwNumberOfPhys))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DOT11_NETWORK_LIST>), nameof(dwNumberOfItems))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<WLAN_AVAILABLE_NETWORK_LIST>), nameof(dwNumberOfItems))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<WLAN_BSS_LIST>), nameof(dwNumberOfItems))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[PInvokeData("wlanapi.h")]
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<WLAN_DEVICE_SERVICE_GUID_LIST>), nameof(dwNumberOfItems))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<WLAN_HOSTED_NETWORK_STATUS>), nameof(dwNumberOfPeers))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<WLAN_INTERFACE_INFO_LIST>), nameof(dwNumberOfItems))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<WLAN_PROFILE_INFO_LIST>), nameof(dwNumberOfItems))]
		[StructLayout(LayoutKind.Sequential)]
