...
using static Crystal.PInvoke.SetupAPI;
...
namespace Crystal.PInvoke
{
	...
	public static partial class CfgMgr32
	{
		...
		[StructLayout(LayoutKind.Sequential)]
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<BUSNUMBER_RESOURCE>), "*")]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<CS_DES>), nameof(CSD_SignatureLength))]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<DMA_RESOURCE>), "*")]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<IO_RESOURCE>), "*")]
		[StructLayout(LayoutKind.Sequential, Pack = 4)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<IRQ_RESOURCE_32>), "*")]
		[StructLayout(LayoutKind.Sequential)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<IRQ_RESOURCE_64>), "*")]
		[StructLayout(LayoutKind.Sequential, Pack = 4)]
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<MEM_RESOURCE>), "*")]
		[StructLayout(LayoutKind.Sequential, Pack = 4)]
