...
namespace Crystal.PInvoke
{
	public static partial class NetApi32
	{
		...
		public class DSREG_JOIN_INFO : SafeHANDLE
		{
			...
			/// <summary>
			/// Representations of the certification for the join. This is a pointer to <c>CERT_CONTEXT</c> structure which can be found in <c>Crystal.PInvoke.Cryptography</c>.
			/// </summary>
			...
			/// <summary>
			/// Internal method that actually releases the handle. This is called by <see cref="M:Crystal.PInvoke.SafeHANDLE.ReleaseHandle"/>
