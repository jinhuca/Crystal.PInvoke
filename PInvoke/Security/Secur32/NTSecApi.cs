...
namespace Crystal.PInvoke
{
	...
	public static partial class Secur32
	{
		...
		{
			/// <summary>Notify when any of the audited Crystal are changed.</summary>
		...
		[StructLayout(LayoutKind.Sequential)]
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<KERB_QUERY_TKT_CACHE_RESPONSE>), nameof(CountOfTickets))]
