...
namespace Crystal.PInvoke
{
	...
	public static partial class Authz
	{
		...
		public static extern bool AuthzInstallSecurityEventSource([Optional] uint dwFlags,
			[In, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(CrystalCustomMarshaler<AUTHZ_SOURCE_SCHEMA_REGISTRATION>))] AUTHZ_SOURCE_SCHEMA_REGISTRATION pRegistration);
		...
		[PInvokeData("authz.h", MSDNShortId = "8b4d6e14-fb9c-428a-bd94-34eba668edc6")]
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<AUTHZ_SOURCE_SCHEMA_REGISTRATION>), nameof(dwObjectTypeNameCount))]
