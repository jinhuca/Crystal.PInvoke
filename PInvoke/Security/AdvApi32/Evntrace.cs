...
namespace Crystal.PInvoke
{
	public static partial class AdvApi32
	{
		...
		/// events, but while it is disabled, it does not.
		/// </para>
		/// <para>Event Tracing for Windows (ETW) supports several Crystal of filtering.</para>
		/// <list type="bullet">
		/// <item>
		/// <term>
		...
		/// Crystal of events and use this value to enable or disable their generation.
		/// </remarks>
