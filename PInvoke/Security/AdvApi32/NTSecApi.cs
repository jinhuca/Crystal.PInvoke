...
namespace Crystal.PInvoke
{
	...
	public static partial class AdvApi32
	{
		...
		public struct POLICY_AUDIT_EVENTS_INFO : ICrystalMarshaler
		{
			/// <summary>
			...
			SizeT ICrystalMarshaler.GetNativeSize() => IntPtr.Size * 3 + 36;

			SafeAllocatedMemoryHandle ICrystalMarshaler.MarshalManagedToNative(object obj)
			{
			...
			object ICrystalMarshaler.MarshalNativeToManaged(IntPtr ptr, SizeT size)
			{
