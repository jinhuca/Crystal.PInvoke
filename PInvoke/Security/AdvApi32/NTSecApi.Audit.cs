...
namespace Crystal.PInvoke
{
	public static partial class AdvApi32
	{
		...
		/// <summary>
		/// The <c>AuditComputeEffectivePolicyBySid</c> function computes the effective audit policy for one or more subCrystal for the
		...
		/// A pointer to an array of <c>GUID</c> values that specify the subCrystal for which to compute effective audit policy. For a
		/// list of defined subCrystal, see Auditing Constants.
		/// </param>
		...
		/// themselves. The <c>AUDIT_POLICY_INFORMATION</c> structures specify the effective audit policy for the subCrystal specified by
		...
		/// </param>
		/// <returns>
		/// A list of AUDIT_POLICY_INFORMATION structures that specify the effective audit policy for the subCrystal specified by the
		...
		/// <summary>
		/// The <c>AuditComputeEffectivePolicyByToken</c> function computes the effective audit policy for one or more subCrystal for the
		...
		/// </param>
		/// <returns>
		/// A list of <c>AUDIT_POLICY_INFORMATION</c> structures that specify the effective audit policy for the subCrystal specified by
		/// the pSubCategoryGuids array.
		/// </returns>
		/// <remarks>
		/// To successfully call this function, the caller must have <c>SeSecurityPrivilege</c> or have both <c>AUDIT_QUERY_SYSTEM_POLICY</c>
		...
		/// <summary>The <c>AuditEnumerateCrystal</c> function enumerates the available audit-policy Crystal.</summary>
		/// <param name="ppAuditCrystalArray">
		/// <para>
		...
		/// <c>GUID</c> structures specify the audit-policy Crystal available on the computer.
		/// </para>
		/// <para>When you have finished using this buffer, free it by calling the AuditFree function.</para>
		/// </param>
		/// <param name="pdwCountReturned">A pointer to the number of elements in the ppAuditCrystalArray array.</param>
		/// <returns>
		/// <para>If the function succeeds, it returns <c>TRUE</c>.</para>
		/// <para>If the function fails, it returns <c>FALSE</c>. To get extended error information, call GetLastError.</para>
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/desktop/api/ntsecapi/nf-ntsecapi-auditenumerateCrystal BOOLEAN
		// AuditEnumerateCrystal( GUID **ppAuditCrystalArray, PULONG pdwCountReturned );
		[DllImport(Lib.AdvApi32, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("ntsecapi.h", MSDNShortId = "bcfdb24b-182e-4845-95c0-a210915435ae")]
		[return: MarshalAs(UnmanagedType.U1)]
		public static extern bool AuditEnumerateCrystal(out SafeAuditMemoryHandle ppAuditCrystalArray, out uint pdwCountReturned);

		/// <summary>The <c>AuditEnumerateCrystal</c> function enumerates the available audit-policy Crystal.</summary>
		/// <returns>The <c>GUID</c> structures that specify the audit-policy Crystal available on the computer.</returns>
		[PInvokeData("ntsecapi.h", MSDNShortId = "bcfdb24b-182e-4845-95c0-a210915435ae")]
		public static IEnumerable<Guid> AuditEnumerateCrystal() => AuditEnumerateCrystal(out var h, out var i) ? h.ToIEnum<Guid>((int)i) : throw Win32Error.GetLastError().GetException();
		...
		/// <summary>The <c>AuditEnumerateSubCrystal</c> function enumerates the available audit-policy subCrystal.</summary>
		/// <param name="pAuditCategoryGuid">
		/// The <c>GUID</c> of an audit-policy category for which subCrystal are enumerated. If the value of the bRetrieveAllSubCrystal
		/// parameter is <c>TRUE</c>, this parameter is ignored.
		/// </param>
		/// <param name="bRetrieveAllSubCrystal">
		/// <c>TRUE</c> to enumerate all audit-policy subCrystal; <c>FALSE</c> to enumerate only the subCrystal of the audit-policy
		/// category specified by the pAuditCategoryGuid parameter.
		/// </param>
		/// <param name="ppAuditSubCrystalArray">
		/// <para>
		/// A pointer to a single buffer that contains both an array of pointers to <c>GUID</c> structures and the structures themselves. The
		/// <c>GUID</c> structures specify the audit-policy subCrystal available on the computer.
		/// </para>
		/// <para>When you have finished using this buffer, free it by calling the AuditFree function.</para>
		/// </param>
		/// <param name="pdwCountReturned">
		/// A pointer to the number of audit-policy subCrystal returned in the ppAuditSubCrystalArray array.
		/// </param>
		/// <returns>
		/// <para>If the function succeeds, it returns <c>TRUE</c>.</para>
		/// <para>If the function fails, it returns <c>FALSE</c>. To get extended error information, call GetLastError.</para>
		/// </returns>
		// https://docs.microsoft.com/en-us/windows/desktop/api/ntsecapi/nf-ntsecapi-auditenumeratesubCrystal BOOLEAN
		// AuditEnumerateSubCrystal( const GUID *pAuditCategoryGuid, BOOLEAN bRetrieveAllSubCrystal, GUID **ppAuditSubCrystalArray,
		// PULONG pdwCountReturned );
		[DllImport(Lib.AdvApi32, SetLastError = true, ExactSpelling = true)]
		[PInvokeData("ntsecapi.h", MSDNShortId = "c5af83f4-9524-4a39-ad1d-39b21bb073bd")]
		[return: MarshalAs(UnmanagedType.U1)]
		public static extern bool AuditEnumerateSubCrystal(in Guid pAuditCategoryGuid, [MarshalAs(UnmanagedType.U1)] bool bRetrieveAllSubCrystal, out SafeAuditMemoryHandle ppAuditSubCrystalArray, out uint pdwCountReturned);

		/// <summary>The <c>AuditEnumerateSubCrystal</c> function enumerates the available audit-policy subCrystal.</summary>
		/// <param name="pAuditCategoryGuid">
		/// The <c>GUID</c> of an audit-policy category for which subCrystal are enumerated. If the value is <see langword="null"/>, then
		/// all subCrystal are enumerated.
		/// </param>
		/// <returns>A list of <c>GUID</c> structures specify the audit-policy subCrystal available on the computer.</returns>
		[PInvokeData("ntsecapi.h", MSDNShortId = "c5af83f4-9524-4a39-ad1d-39b21bb073bd")]
		public static IEnumerable<Guid> AuditEnumerateSubCrystal(Guid? pAuditCategoryGuid = null)
		{
			var guid = pAuditCategoryGuid.HasValue ? pAuditCategoryGuid.Value : Guid.Empty;
			return AuditEnumerateSubCrystal(guid, !pAuditCategoryGuid.HasValue, out var h, out var c) ? h.ToIEnum<Guid>((int)c) : throw Win32Error.GetLastError().GetException();
		}
		...
		/// <summary>
		/// The <c>AuditQueryPerUserPolicy</c> function retrieves per-user audit policy in one or more audit-policy subCrystal for the
		/// specified principal.
		/// </summary>
		/// <param name="pSid">
		...
		/// </param>
		/// <param name="pSubCategoryGuids">
		/// A pointer to an array of <c>GUID</c> values that specify the subCrystal for which to query audit policy. For a list of defined
		/// audit-policy subCrystal, see Auditing Constants.
		/// </param>
		/// <param name="dwPolicyCount">The number of elements in each of the pSubCategoryGuids and ppAuditPolicy arrays.</param>
		/// <param name="ppAuditPolicy">
		/// <para>
		/// A pointer to a single buffer that contains both an array of pointers to AUDIT_POLICY_INFORMATION structures and the structures
		/// themselves. The <c>AUDIT_POLICY_INFORMATION</c> structures specify the per-user audit policy for the subCrystal specified by
		/// the pSubCategoryGuids array.
		/// </para>
		/// <para>When you have finished using this buffer, free it by calling the AuditFree function.</para>
		/// </param>
		...
		/// </param>
		/// <returns>
		/// A list of <c>AUDIT_POLICY_INFORMATION</c> structures that specify the per-user audit policy for the subCrystal specified by
		/// the pSubCategoryGuids array.
		/// </returns>
		/// <remarks>
		/// To successfully call this function, the caller must have <c>SeSecurityPrivilege</c> or have <c>AUDIT_QUERY_USER_POLICY</c> access
		...
		/// <summary>The <c>AuditQuerySystemPolicy</c> function retrieves system audit policy for one or more audit-policy subCrystal.</summary>
		/// <param name="pSubCategoryGuids">
		/// A pointer to an array of <c>GUID</c> values that specify the subCrystal for which to query audit policy. For a list of defined
		/// audit-policy subCrystal, see Auditing Constants.
		/// </param>
		...
		/// <para>
		/// A pointer to a single buffer that contains both an array of pointers to AUDIT_POLICY_INFORMATION structures and the structures
		/// themselves. The <c>AUDIT_POLICY_INFORMATION</c> structures specify the system audit policy for the subCrystal specified by the
		/// pSubCategoryGuids array.
		/// </para>
		/// <para>When you have finished using this buffer, free it by calling the AuditFree function.</para>
		/// </param>
		...
		/// </param>
		/// <returns>
		/// A list of <c>AUDIT_POLICY_INFORMATION</c> structures that specify the system audit policy for the subCrystal specified by the
		/// pSubCategoryGuids array.
		/// </returns>
		/// <remarks>
		/// To successfully call this function, the caller must have <c>SeSecurityPrivilege</c> or have <c>AUDIT_QUERY_SYSTEM_POLICY</c>
		...
		/// <summary>
		/// The <c>AuditSetPerUserPolicy</c> function sets per-user audit policy in one or more audit subCrystal for the specified principal.
		/// </summary>
		/// <param name="pSid">
		...
		/// <summary>The <c>AuditSetSystemPolicy</c> function sets system audit policy for one or more audit-policy subCrystal.</summary>
		/// <param name="pAuditPolicy">
		/// <para>
