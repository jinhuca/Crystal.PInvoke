...
namespace Crystal.PInvoke
{
	public static partial class AdvApi32
	{
		...
		[CrystalMarshaler(typeof(AnySizeStringMarshaler<SID>), nameof(SubAuthorityCount))]
		[StructLayout(LayoutKind.Sequential)]
		public struct SID
		{
			/// <summary />
		...
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<TOKEN_GROUPS>), nameof(GroupCount))]
		[StructLayout(LayoutKind.Sequential)]
		...
		[StructLayout(LayoutKind.Sequential)]
		[CrystalMarshaler(typeof(SafeAnysizeStructMarshaler<TOKEN_PRIVILEGES>), nameof(PrivilegeCount))]
