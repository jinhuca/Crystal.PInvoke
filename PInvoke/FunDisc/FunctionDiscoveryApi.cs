...
using static Crystal.PInvoke.PropSys;
...
namespace Crystal.PInvoke
{
	...
	public static partial class FunDisc
	{
		...
		public interface IFunctionDiscovery
		{
			...
			/// </param>
			/// <param name="fIncludeAllSubCrystal">
			/// <para>
			/// If <c>TRUE</c>, this method recursively enumerates all the subCrystal of the category specified in pszCategory, returning
			/// a collection containing function instances from all the subCrystal of pszCategory.
			/// </para>
			/// <para>
			...
			/// </para>
			/// <para>
			/// Subcategory queries are only supported for layered Crystal and some provider Crystal. The Registry Provider, the PnP-X
			...
			// HRESULT GetInstanceCollection( const WCHAR *pszCategory, const WCHAR *pszSubCategory, BOOL fIncludeAllSubCrystal,
			...
			HRESULT GetInstanceCollection([MarshalAs(UnmanagedType.LPWStr)] string pszCategory, [MarshalAs(UnmanagedType.LPWStr), Optional] string pszSubCategory,
				[MarshalAs(UnmanagedType.Bool)] bool fIncludeAllSubCrystal, out IFunctionInstanceCollection ppIFunctionInstanceCollection);
			...
			/// <param name="fIncludeAllSubCrystal">
			/// <para>
			/// If <c>TRUE</c>, this method recursively creates a query for all the subCrystal of the category specified in pszCategory,
			/// returning a collection containing function instances from all the subCrystal of pszCategory.
			/// </para>
			/// <para>
			...
			// HRESULT CreateInstanceCollectionQuery( const WCHAR *pszCategory, const WCHAR *pszSubCategory, BOOL fIncludeAllSubCrystal,
			...
			HRESULT CreateInstanceCollectionQuery([MarshalAs(UnmanagedType.LPWStr)] string pszCategory,
				...
				[MarshalAs(UnmanagedType.Bool)] bool fIncludeAllSubCrystal,
		...
		public interface IFunctionInstanceCollectionQuery
		{
			...
			/// <para>
			/// <c>AddQueryConstraint</c> will fail with an error if the IFunctionInstanceCollectionQuery object includes all subCrystal
			...
			/// that does not include all subCrystal. You can create such an object by calling CreateInstanceCollectionQuery with the
			/// fIncludeAllSubCrystal parameter set to <c>false</c>.
			/// </para>
			/// </remarks>
