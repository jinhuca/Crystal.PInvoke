...
namespace Crystal.PInvoke
{
	public static partial class OleAut32
	{
		...
		public interface IEnumWIA_DEV_CAPS : Crystal.Collections.ICOMEnum<WIA_DEV_CAP>
		{
		...
		public interface IEnumWIA_DEV_INFO : Crystal.Collections.ICOMEnum<IWiaPropertyStorage>
		{
		...
		public interface IEnumWIA_FORMAT_INFO : Crystal.Collections.ICOMEnum<WIA_FORMAT_INFO>
		{
		...
		public interface IEnumWiaItem : Crystal.Collections.ICOMEnum<IWiaItem>
		{
