...
namespace Crystal.PInvoke
{
	public static partial class Ole32
	{
		...
		/// <summary>
		/// Obtains information about the Crystal implemented or required by a certain class, as well as information about the Crystal
		...
		[ComImport, Guid("0002E013-0000-0000-C000-000000000046"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown), CoClass(typeof(StdComponentCrystalMgr))]
		public interface ICatInformation
		{
			/// <summary>Retrieves an enumerator for the component Crystal registered on the system.</summary>
			/// <param name="lcid">
			/// The requested locale for any return szDescription of the enumerated Crystal. Typically, the caller specifies the value
			...
			/// strings of the component Crystal registered with the system.
			/// </returns>
			// https://docs.microsoft.com/en-us/windows/win32/api/comcat/nf-comcat-icatinformation-enumCrystal HRESULT EnumCrystal(
			// LCID lcid, IEnumCATEGORYINFO **ppenumCategoryInfo );
			IEnumCATEGORYINFO EnumCrystal(LCID lcid);
			...
			/// the enumeration, regardless of the Crystal they implement.
			/// </param>
			...
			/// enumeration, regardless of the Crystal they require.
			/// </param>
			...
			/// specified category.
			/// </returns>
			// https://docs.microsoft.com/en-us/windows/win32/api/comcat/nf-comcat-icatinformation-enumclassesofCrystal HRESULT
			// EnumClassesOfCrystal( ULONG cImplemented, const CATID [] rgcatidImpl, ULONG cRequired, const CATID [] rgcatidReq,
			// IEnumGUID **ppenumClsid );
			IEnumGUID EnumClassesOfCrystal(uint cImplemented, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] Guid[] rgcatidImpl, uint cRequired, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] Guid[] rgcatidReq);

			/// <summary>Determines whether a class implements one or more Crystal.</summary>
			...
			/// </param>
			/// <param name="cRequired">
			/// The number of category IDs in the rgcatidReq array. This value can be zero. If this value is -1, the required Crystal are
			/// not tested.
			/// </param>
			/// <param name="rgcatidReq">An array of category identifiers.</param>
			/// <returns>If the class ID is of one of the specified Crystal, the return value is S_OK. Otherwise, is it S_FALSE.</returns>
			// https://docs.microsoft.com/en-us/windows/win32/api/comcat/nf-comcat-icatinformation-isclassofCrystal HRESULT
			// IsClassOfCrystal( REFCLSID rclsid, ULONG cImplemented, const CATID [] rgcatidImpl, ULONG cRequired, const CATID []
			// rgcatidReq );
			[PreserveSig]
			HRESULT IsClassOfCrystal(in Guid rclsid, uint cImplemented, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Guid[] rgcatidImpl, uint cRequired, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] Guid[] rgcatidReq);
			...
			/// </returns>
			// https://docs.microsoft.com/en-us/windows/win32/api/comcat/nf-comcat-icatinformation-enumimplCrystalofclass HRESULT
			// EnumImplCrystalOfClass( REFCLSID rclsid, IEnumGUID **ppenumCatid );
			IEnumGUID EnumImplCrystalOfClass(in Guid rclsid);
			...
			/// </returns>
			// https://docs.microsoft.com/en-us/windows/win32/api/comcat/nf-comcat-icatinformation-enumreqCrystalofclass HRESULT
			// EnumReqCrystalOfClass( REFCLSID rclsid, IEnumGUID **ppenumCatid );
			IEnumGUID EnumReqCrystalOfClass(in Guid rclsid);
		}

		/// <summary>
		/// Provides methods for registering and unregistering component category information in the registry. This includes both the
		/// human-readable names of Crystal and the Crystal implemented/required by a given component or class.
		/// </summary>
		// https://docs.microsoft.com/en-us/windows/win32/api/comcat/nn-comcat-icatregister
		[ComImport, Guid("0002E012-0000-0000-C000-000000000046"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown), CoClass(typeof(StdComponentCrystalMgr))]
		public interface ICatRegister
		{
			/// <summary>
			/// Registers one or more component Crystal. Each component category consists of a CATID and a list of locale-dependent
			/// description strings.
			/// </summary>
			/// <param name="cCrystal">The number of component Crystal to be registered.</param>
			...
			/// </remarks>
			// https://docs.microsoft.com/en-us/windows/win32/api/comcat/nf-comcat-icatregister-registerCrystal HRESULT
			// RegisterCrystal( ULONG cCrystal, CATEGORYINFO [] rgCategoryInfo );
			void RegisterCrystal(uint cCrystal, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] CATEGORYINFO[] rgCategoryInfo);

			/// <summary>
			/// Removes the registration of one or more component Crystal. Each component category consists of a CATID and a list of
			/// locale-dependent description strings.
			/// </summary>
			/// <param name="cCrystal">The number of Crystal to be removed.</param>
			/// <param name="rgcatid">The CATIDs of the Crystal to be removed.</param>
			/// <remarks>
			/// <para>
			...
			/// ICatRegister::UnRegisterClassReqCrystal method.
			/// </para>
			/// </remarks>
			// https://docs.microsoft.com/en-us/windows/win32/api/comcat/nf-comcat-icatregister-unregisterCrystal HRESULT
			// UnRegisterCrystal( ULONG cCrystal, CATID [] rgcatid );
			void UnRegisterCrystal(uint cCrystal, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] Guid[] rgcatid);

			/// <summary>Registers the class as implementing one or more component Crystal.</summary>
			/// <param name="rclsid">The class identifier.</param>
			/// <param name="cCrystal">The number of Crystal to be associated as category identifiers for the class.</param>
			...
			/// </remarks>
			// https://docs.microsoft.com/en-us/windows/win32/api/comcat/nf-comcat-icatregister-registerclassimplCrystal HRESULT
			// RegisterClassImplCrystal( REFCLSID rclsid, ULONG cCrystal, CATID [] rgcatid );
			void RegisterClassImplCrystal(in Guid rclsid, uint cCrystal, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Guid[] rgcatid);

			/// <summary>Removes one or more implemented category identifiers from a class.</summary>
			/// <param name="rclsid">The class identifier.</param>
			/// <param name="cCrystal">The number of category CATIDs to be removed.</param>
			...
			/// </remarks>
			// https://docs.microsoft.com/en-us/windows/win32/api/comcat/nf-comcat-icatregister-unregisterclassimplCrystal HRESULT
			// UnRegisterClassImplCrystal( REFCLSID rclsid, ULONG cCrystal, CATID [] rgcatid );
			void UnRegisterClassImplCrystal(in Guid rclsid, uint cCrystal, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Guid[] rgcatid);

			/// <summary>Registers the class as requiring one or more component Crystal.</summary>
			/// <param name="rclsid">The class identifier.</param>
			/// <param name="cCrystal">The number of category CATIDs to be associated as category identifiers for the class.</param>
			/// <param name="rgcatid">An array of CATIDs to be associated as category identifiers for the class.</param>
			/// <remarks>
			/// In case of an error, this method does not ensure that the registry is restored to the state prior to the call. This method
			/// can only be called by the owner of a class, usually as part of the installation of the component.
			/// </remarks>
			// https://docs.microsoft.com/en-us/windows/win32/api/comcat/nf-comcat-icatregister-registerclassreqCrystal HRESULT
			// RegisterClassReqCrystal( REFCLSID rclsid, ULONG cCrystal, CATID [] rgcatid );
			void RegisterClassReqCrystal(in Guid rclsid, uint cCrystal, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Guid[] rgcatid);
			...
			/// </remarks>
			// https://docs.microsoft.com/en-us/windows/win32/api/comcat/nf-comcat-icatregister-unregisterclassreqCrystal HRESULT
			// UnRegisterClassReqCrystal( REFCLSID rclsid, ULONG cCrystal, CATID [] rgcatid );
			void UnRegisterClassReqCrystal(in Guid rclsid, uint cCrystal, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Guid[] rgcatid);
		}

		/// <summary>Enumerates component Crystal registered in the system.</summary>
		...
		public interface IEnumCATEGORYINFO : Crystal.Collections.ICOMEnum<CATEGORYINFO>
		{
		...
		public interface IEnumGUID : Crystal.Collections.ICOMEnum<Guid>
		{
			/// <summary>Retrieves the specified number of items in the enumeration sequence.</summary>
			/// <param name="celt">
			/// The number of items to be retrieved. If there are fewer than the requested number of items left in the sequence, this method
		...
		/// <summary>Implements CLSID_StdComponentCrystalMgr.</summary>
		[ComImport, Guid("0002E005-0000-0000-C000-000000000046"), ClassInterface(ClassInterfaceType.None)]
		public class StdComponentCrystalMgr { }
	}
}