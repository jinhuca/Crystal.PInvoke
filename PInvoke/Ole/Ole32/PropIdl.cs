...
namespace Crystal.PInvoke
{
	public static partial class Ole32
	{
		...
		public interface IEnumSTATPROPSETSTG : Crystal.Collections.ICOMEnum<STATPROPSETSTG>
		{
			/// <summary>
		...
		public interface IEnumSTATPROPSTG : Crystal.Collections.ICOMEnum<STATPROPSTG>
		{
			/// <summary>
