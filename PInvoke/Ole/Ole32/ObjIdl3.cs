...
namespace Crystal.PInvoke
{
	public static partial class Ole32
	{
		...
		public static IEnumerable<ContextProperty> Enumerate(this IEnumContextProps e) => Crystal.Collections.IEnumFromCom<ContextProperty>.Create(e);
		...
		/// <returns>The enumerated values.</returns>
		public static IEnumerable<STATSTG> Enumerate(this IEnumSTATSTG e) => Crystal.Collections.IEnumFromCom<STATSTG>.Create(e);
		...
		/// <returns>The enumerated values.</returns>
		public static IEnumerable<IntPtr> Enumerate(this IEnumUnknown e) => Crystal.Collections.IEnumFromCom<IntPtr>.Create(e);
		...
		/// <seealso cref="Crystal.PInvoke.Ole32.IEnumUnknown"/>
